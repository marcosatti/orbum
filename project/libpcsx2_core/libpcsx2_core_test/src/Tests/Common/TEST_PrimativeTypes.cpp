...
#define BOOST_TEST_MODULE Test_PrimativeTypes
#include <boost/test/unit_test.hpp>

/*
BOOST_AUTO_TEST_CASE(Test_PrimativeTypes_IS_F32_32BIT) 
{
...
BOOST_AUTO_TEST_CASE(Test_PrimativeTypes_IS_F32_IEEE754)
{
	// IEEE 754 also known as IEC 559.
	BOOST_TEST(true == std::numeric_limits<f32>::is_iec559); 
}

BOOST_AUTO_TEST_CASE(Test_PrimativeTypes_U128_ORDERING)
{
