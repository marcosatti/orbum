...
struct Constants
{
	...
	static constexpr s16 VALUE_S16_MAX = std::numeric_limits<s16>::max();
	static constexpr s16 VALUE_S16_MIN = std::numeric_limits<s16>::min();
	static constexpr u32 VALUE_U32_MAX = std::numeric_limits<u32>::max();
	static constexpr s32 VALUE_S32_MAX = std::numeric_limits<s32>::max();
	static constexpr s32 VALUE_S32_MIN = std::numeric_limits<s32>::min();
	static constexpr u64 VALUE_U64_MAX = std::numeric_limits<u64>::max();
