	...
	SPU2Core_t(CORE_ID, dmaChannel)
{
	...
	TSAL = std::make_shared<PairRegister16_t>("SPU2 C0 TSAL", false, false, TSAH);
	DATA0 = std::make_shared<Register16_t>("SPU2 C0 DATA0", false, false);
	DATA1 = std::make_shared<Register16_t>("SPU2 C0 DATA1", false, false);
	ADMAS = std::make_shared<SPU2CoreRegister_ADMAS_t>("SPU2 C0 ADMAS", false, false, CORE_ID);
	...
	SPU2Core_t(CORE_ID, dmaChannel)
{
	...
	TSAL = std::make_shared<PairRegister16_t>("SPU2 C1 TSAL", false, false, TSAH);
	DATA0 = std::make_shared<Register16_t>("SPU2 C1 DATA0", false, false);
	DATA1 = std::make_shared<Register16_t>("SPU2 C1 DATA1", false, false);
	ADMAS = std::make_shared<SPU2CoreRegister_ADMAS_t>("SPU2 C1 ADMAS", false, false, CORE_ID);
