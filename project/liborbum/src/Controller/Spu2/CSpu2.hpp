...
public:
	...
	void handle_interrupt_check(Spu2Core_Base & spu2_core) const;
	...
	bool handle_dma_transfer(Spu2Core_Base & spu2_core) const;
	...
	int transfer_data_adma_write(Spu2Core_Base & spu2_core) const;
	int transfer_data_adma_read(Spu2Core_Base & spu2_core) const;
	int transfer_data_mdma_write(Spu2Core_Base & spu2_core) const;
	int transfer_data_mdma_read(Spu2Core_Base & spu2_core) const;
	...
	uhword read_hword_memory(Spu2Core_Base & spu2_core, const uptr address) const;
	void write_hword_memory(Spu2Core_Base & spu2_core, const uptr address, const uhword value) const;
	...
	bool handle_sound_generation(Spu2Core_Base & spu2_core) const;
};
