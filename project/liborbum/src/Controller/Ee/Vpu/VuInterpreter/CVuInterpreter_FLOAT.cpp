...
{
	// Fd = Fs - Ft.
	auto& destReg = mVUCore->VF[mVUInstruction.fd()];
	auto& source1Reg = mVUCore->VF[mVUInstruction.fs()];
	auto& source2Reg = mVUCore->VF[mVUInstruction.ft()];
