...
void CEeCoreInterpreter::QMFC2(const EeCoreInstruction inst) const
{
...
void CEeCoreInterpreter::QMTC2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::CFC2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::CTC2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::BC2F(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
        return;
...
void CEeCoreInterpreter::BC2FL(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
        return;
...
void CEeCoreInterpreter::BC2T(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
        return;
...
void CEeCoreInterpreter::BC2TL(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
        return;
...
void CEeCoreInterpreter::VCALLMS(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
		return;
...
void CEeCoreInterpreter::VCALLMSR(const EeCoreInstruction inst) const
{
	if (handle_cop2_usable())
		return;
...
void CEeCoreInterpreter::VABS(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADD(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VADDAbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUB(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSUBAbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMUL(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMULAbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADD(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMADDAbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUB(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAq(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMSUBAbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAX(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAXi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAXbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAXbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAXbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMAXbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINI(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINIi(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINIbc_0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINIbc_1(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINIbc_2(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMINIbc_3(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VOPMULA(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VOPMSUB(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VNOP(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VFTOI0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VFTOI4(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VFTOI12(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VFTOI15(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VITOF0(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VITOF4(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VITOF12(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VITOF15(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VCLIP(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VDIV(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSQRT(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VRSQRT(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VIADD(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VIADDI(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VIAND(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VIOR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VISUB(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMOVE(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMFIR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMTIR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VMR32(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VLQD(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VLQI(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSQD(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VSQI(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VILWR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VISWR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VRINIT(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VRGET(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VRNEXT(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VRXOR(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
...
void CEeCoreInterpreter::VWAITQ(const EeCoreInstruction inst) const
{
	auto& r = core->get_resources();
