...
{
public:
	EECoreInterpreter_s(VM * vm, const VUInterpreter_s & vuInterpreter);
	...
	*/
	void(EECoreInterpreter_s::* EECORE_INSTRUCTION_TABLE[Constants::EE::EECore::NUMBER_INSTRUCTIONS])() =
	{
	...
	*/
	...
	udword DEBUG_HANDLED_EXCEPTION_COUNT = 0;
#endif
	...
	*/
	void handleMMUError(const uptr address, const MMUAccess_t access, const MMUError_t error, const s32 tlbEntryIndex);
	...
	*/
	bool getPhysicalAddress(const uptr address);
};