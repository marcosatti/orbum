...
void EECoreInterpreter_s::CFC2()
{
	...
	destReg->write_udword(0, static_cast<s64>(source1Reg->read_uword()));
}
...
void EECoreInterpreter_s::CTC2()
{
	...
	destReg->write_uword(static_cast<uword>(source1Reg->read_uword(0)));
}
...
void EECoreInterpreter_s::VISWR()
{
	...
	// Delegate to the VU0 system.
	mVU0Interpreter->mVUInstruction = VuInstruction(mEECoreInstruction.getValue());
