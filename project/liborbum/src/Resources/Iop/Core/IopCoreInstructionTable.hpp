...
For example (pseduo-code): 
 ...
 Info = IOPCoreInstructionTable::get_instruction_info(MIPSInstruction)
...
struct IOPCoreInstructionTable
{
	...
	*/
	...
	struct IOPCoreInstructionInfo_t
	{
		...
		const IOPCoreInstructionInfo_t * (*mLookupFuncion)(const IopCoreInstruction * instruction);
	...
	*/
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_OPCODE_LOOKUP(const IopCoreInstruction * instruction);
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_SPECIAL_LOOKUP(const IopCoreInstruction * instruction);
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_REGIMM_LOOKUP(const IopCoreInstruction * instruction);
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_COP0_LOOKUP(const IopCoreInstruction * instruction);
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_COP2_LOOKUP(const IopCoreInstruction * instruction);
	static const IOPCoreInstructionInfo_t * IOPCORE_INSTRUCTION_CP2BSC_LOOKUP(const IopCoreInstruction * instruction);
	...
	*/
	static const IOPCoreInstructionInfo_t * getInfo(const IopCoreInstruction * instruction);	
};
