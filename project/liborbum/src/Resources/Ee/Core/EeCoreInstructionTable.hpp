...
For example (pseduo-code): 
 ...
 Info = EECoreInstructionTable::get_instruction_info(MIPSInstruction)
...
struct EECoreInstructionTable
{
	...
	*/
	...
	struct EECoreInstructionInfo_t
	{
		...
		const EECoreInstructionInfo_t * (*mLookupFuncion)(const EeCoreInstruction * instruction);
	...
	*/
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_OPCODE_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_SPECIAL_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_REGIMM_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_MMI_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_MMI0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_MMI1_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_MMI2_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_MMI3_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_COP0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_BC0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_C0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_COP1_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_BC1_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_S_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_W_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_COP2_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_CO0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_BC2_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_CO1_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_VEXT0_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_VEXT1_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_VEXT2_LOOKUP(const EeCoreInstruction * instruction);
	static const EECoreInstructionInfo_t * EECORE_INSTRUCTION_VEXT3_LOOKUP(const EeCoreInstruction * instruction);
	...
	*/
	static const EECoreInstructionInfo_t * getInfo(const EeCoreInstruction * instruction);
};
