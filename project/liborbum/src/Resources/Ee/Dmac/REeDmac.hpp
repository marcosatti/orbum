...
struct REeDmac
{
	...
	EeDmacChannel_Asr<EeDmacChannelRegister_Chcr>       channel_vif0;
	EeDmacChannel_Asr<EeDmacChannelRegister_Chcr>       channel_vif1;
	EeDmacChannel_Asr<EeDmacChannelRegister_Chcr>       channel_gif;
	EeDmacChannel_Base<EeDmacChannelRegister_Chcr>      channel_fromipu;
	EeDmacChannel_Tadr<EeDmacChannelRegister_Chcr>      channel_toipu;
	EeDmacChannel_Base<EeDmacChannelRegister_Chcr_Sif0> channel_sif0;
	EeDmacChannel_Tadr<EeDmacChannelRegister_Chcr_Sif1> channel_sif1;
	EeDmacChannel_Base<EeDmacChannelRegister_Chcr_Sif2> channel_sif2;
	EeDmacChannel_Sadr<EeDmacChannelRegister_Chcr>      channel_fromspr;
	EeDmacChannel_Tadr_Sadr<EeDmacChannelRegister_Chcr> channel_tospr;
