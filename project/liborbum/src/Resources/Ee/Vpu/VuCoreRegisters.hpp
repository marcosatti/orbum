...
#include "Resources/Ee/Vpu/VuVectorField.hpp"

/// The VU unit Status flags register.
/// See VU Users Manual page 39.
class VuCoreRegister_Status : public SizedWordRegister
{
public:
...
/// See VU Users Manual page 39.
class VuCoreRegister_Mac : public SizedWordRegister
{
public:
...
class VuCoreRegister_Clipping : public SizedWordRegister
{
public:
...
class VuCoreRegister_Cmsar : public SizedWordRegister
{
public:	
