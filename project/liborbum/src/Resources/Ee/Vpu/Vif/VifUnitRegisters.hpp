...
class VifUnitRegister_Cycle : public SizedWordRegister
{
public:
...
class VifUnitRegister_Mask : public SizedWordRegister
{
public:
...
class VifUnitRegister_Mode : public SizedWordRegister
{
public:	
	static constexpr Bitfield MOD = Bitfield(0, 2);
};

class VifUnitRegister_Itop : public SizedWordRegister
{
public:
	static constexpr Bitfield ITOP = Bitfield(0, 10);
};

class VifUnitRegister_Itops : public SizedWordRegister
{
public:
	static constexpr Bitfield ITOPS = Bitfield(0, 10);
};

class VifUnitRegister_Base : public SizedWordRegister
{
public:
	static constexpr Bitfield BASE = Bitfield(0, 10);
};

class VifUnitRegister_Ofst : public SizedWordRegister
{
public:
	static constexpr Bitfield OFFSET = Bitfield(0, 10);
};

class VifUnitRegister_Top : public SizedWordRegister
{
public:
	static constexpr Bitfield TOP = Bitfield(0, 10);
};

class VifUnitRegister_Tops : public SizedWordRegister
{
public:
	static constexpr Bitfield TOPS = Bitfield(0, 10);
};

class VifUnitRegister_Mark : public SizedWordRegister
{
public:
	static constexpr Bitfield MARK = Bitfield(0, 16);
};

class VifUnitRegister_Num : public SizedWordRegister
{
public:
	static constexpr Bitfield NUM = Bitfield(0, 8);
};

class VifUnitRegister_Code : public SizedWordRegister
{
public:
...
class VifUnitRegister_Stat : public SizedWordRegister
{
public:
	...
	/// Returns if the VIF is in the stalled status.
	/// (Checks bits VSS, VFS, VIS, INT, ER0, ER1.)
	bool is_stalled();
};

class VifUnitRegister_Fbrst : public SizedWordRegister
{
public:
...
class VifUnitRegister_Err : public SizedWordRegister
{
public:
