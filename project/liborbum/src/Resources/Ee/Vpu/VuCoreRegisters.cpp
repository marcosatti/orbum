...
constexpr Bitfield VuCoreRegister_Mac::X_FLAGS[4];
constexpr Bitfield VuCoreRegister_Mac::Y_FLAGS[4];
constexpr Bitfield VuCoreRegister_Mac::Z_FLAGS[4];
constexpr Bitfield VuCoreRegister_Mac::W_FLAGS[4];

void VuCoreRegister_Status::set_z_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::set_s_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::set_u_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::set_o_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::set_i_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::set_d_flag_sticky(const uword value)
{
...
void VuCoreRegister_Status::clear_flags()
{
	insert_field(Z, 0);
	insert_field(S, 0);
	insert_field(U, 0);
...
VuCoreRegister_Mac::VuCoreRegister_Mac() :
	status(nullptr)
{
}

void VuCoreRegister_Mac::update_vector_field(const VuVectorField::Field field, const FpuFlags& flags)
{
...
void VuCoreRegister_Mac::clear_vector_field(const VuVectorField::Field field)
{
...
void VuCoreRegister_Clipping::shift_judgement()
{
