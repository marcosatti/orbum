...
TEST_F(TEST_IOPCoreInterpreter_s, MIPS_INSTRUCTION_IMPLEMENTATIONS)
{
	...
	// LB
	{
		...
		vm->getResources()->IOP->PhysicalMMU->writeByte(core->getContext(), 0x0, 0xCD);
		core->LB();
	...
	// LBU
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeByte(core->getContext(), 0x0, 0xAB);
		core->LBU();
	...
	// LH
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeHword(core->getContext(), 0x0, 0xCDEF);
		core->LH();
	...
	// LHU
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeHword(core->getContext(), 0x0, 0xABCD);
		core->LHU();
	...
	// LW
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeWord(core->getContext(), 0x0, 0x12345678);
		core->LW();
	...
	// SB
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[2]->writeWord(core->getContext(), 0x1234ABCD);
		core->SB();
		EXPECT_EQ(0xCD, vm->getResources()->IOP->PhysicalMMU->readByte(core->getContext(), 0x0));
	}
	...
	// SH
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[2]->writeWord(core->getContext(), 0x1234ABCD);
		core->SH();
		EXPECT_EQ(0xABCD, vm->getResources()->IOP->PhysicalMMU->readHword(core->getContext(), 0x0));
	}
	...
	// SW
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[2]->writeWord(core->getContext(), 0x1234ABCD);
		core->SW();
		EXPECT_EQ(0x1234ABCD, vm->getResources()->IOP->PhysicalMMU->readWord(core->getContext(), 0x0));
	}
	...
	// LWL
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeWord(core->getContext(), 0x0, 0x01234567);
		core->LWL();
	...
	// LWR
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[2]->writeWord(core->getContext(), 0xCDCDCDCD);
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->PhysicalMMU->writeWord(core->getContext(), 0x4, 0x89ABCDEF);
		core->LWR();
	...
	// SWL
	{
		...
		vm->getResources()->IOP->PhysicalMMU->writeWord(core->getContext(), 0x0, 0xABABABAB);
		core->SWL();
		EXPECT_EQ(0xABAB1111, vm->getResources()->IOP->PhysicalMMU->readWord(core->getContext(), 0x0));
	}
	...
	// SWR
	{
		...
		vm->getResources()->IOP->IOPCore->R3000->GPR[4]->writeWord(core->getContext(), 0xA0000004);
		vm->getResources()->IOP->IOPCore->R3000->GPR[2]->writeWord(core->getContext(), 0x11111111);
		vm->getResources()->IOP->PhysicalMMU->writeWord(core->getContext(), 0x4, 0xCDCDCDCD);
		core->SWR();
		EXPECT_EQ(0x1111CDCD, vm->getResources()->IOP->PhysicalMMU->readWord(core->getContext(), 0x4));
	}
}
