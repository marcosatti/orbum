...
public:
	...
	*/
	...
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_00f0;

	// 0x12001000.
	std::shared_ptr<Memory_t>         GS_P_REGISTER_CSR;
	std::shared_ptr<Memory_t>         GS_P_REGISTER_IMR;
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_1020;
	std::shared_ptr<Memory_t>         GS_P_REGISTER_BUSDIR;
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_1050;
	std::shared_ptr<Memory_t>         GS_P_REGISTER_SIGLBLID;
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_1090;
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_1100;

	// 0x12002000.
	std::shared_ptr<ConstantMemory_t>     GS_P_REGISTER_SPE_2000;
