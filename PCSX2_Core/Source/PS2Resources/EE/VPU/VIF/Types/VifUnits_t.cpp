...
VifUnit_t::VifUnit_t(const u32 & unitID) :
	mUnitID(unitID),
	mR0(std::make_shared<Register32_t>()),
	mR1(std::make_shared<Register32_t>()),
	mR2(std::make_shared<Register32_t>()),
	mR3(std::make_shared<Register32_t>()),
	mC0(std::make_shared<Register32_t>()),
	mC1(std::make_shared<Register32_t>()),
	mC2(std::make_shared<Register32_t>()),
	mC3(std::make_shared<Register32_t>()),
