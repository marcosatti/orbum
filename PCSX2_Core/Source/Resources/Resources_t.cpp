...
void Resources_t::postInit_IOP() const
{
	// Initalise physical memory map of IOP.
	{
		...
		// IOP Registers.
		{
			...
			IOP->MMU->mapObject(0x1F90019C, IOP->SPU2->CORES[0]->IRQAH);
			IOP->MMU->mapObject(0x1F90019E, IOP->SPU2->CORES[0]->IRQAL);
			...
			IOP->MMU->mapObject(0x1F9001A8, IOP->SPU2->CORES[0]->TSAH);
			IOP->MMU->mapObject(0x1F9001AA, IOP->SPU2->CORES[0]->TSAL);
			...
			IOP->MMU->mapObject(0x1F9001C0, IOP->SPU2->CORES[0]->VOICES[0]->SSAH);
			IOP->MMU->mapObject(0x1F9001C2, IOP->SPU2->CORES[0]->VOICES[0]->SSAL);
			IOP->MMU->mapObject(0x1F9001C4, IOP->SPU2->CORES[0]->VOICES[0]->LSAXH);
			IOP->MMU->mapObject(0x1F9001C6, IOP->SPU2->CORES[0]->VOICES[0]->LSAXL);
			IOP->MMU->mapObject(0x1F9001C8, IOP->SPU2->CORES[0]->VOICES[0]->NAXH);
			IOP->MMU->mapObject(0x1F9001CA, IOP->SPU2->CORES[0]->VOICES[0]->NAXL);
			IOP->MMU->mapObject(0x1F9001CC, IOP->SPU2->CORES[0]->VOICES[1]->SSAH);
			IOP->MMU->mapObject(0x1F9001CE, IOP->SPU2->CORES[0]->VOICES[1]->SSAL);
			IOP->MMU->mapObject(0x1F9001D0, IOP->SPU2->CORES[0]->VOICES[1]->LSAXH);
			IOP->MMU->mapObject(0x1F9001D2, IOP->SPU2->CORES[0]->VOICES[1]->LSAXL);
			IOP->MMU->mapObject(0x1F9001D4, IOP->SPU2->CORES[0]->VOICES[1]->NAXH);
			IOP->MMU->mapObject(0x1F9001D6, IOP->SPU2->CORES[0]->VOICES[1]->NAXL);
			IOP->MMU->mapObject(0x1F9001D8, IOP->SPU2->CORES[0]->VOICES[2]->SSAH);
			IOP->MMU->mapObject(0x1F9001DA, IOP->SPU2->CORES[0]->VOICES[2]->SSAL);
			IOP->MMU->mapObject(0x1F9001DC, IOP->SPU2->CORES[0]->VOICES[2]->LSAXH);
			IOP->MMU->mapObject(0x1F9001DE, IOP->SPU2->CORES[0]->VOICES[2]->LSAXL);
			IOP->MMU->mapObject(0x1F9001E0, IOP->SPU2->CORES[0]->VOICES[2]->NAXH);
			IOP->MMU->mapObject(0x1F9001E2, IOP->SPU2->CORES[0]->VOICES[2]->NAXL);
			IOP->MMU->mapObject(0x1F9001E4, IOP->SPU2->CORES[0]->VOICES[3]->SSAH);
			IOP->MMU->mapObject(0x1F9001E6, IOP->SPU2->CORES[0]->VOICES[3]->SSAL);
			IOP->MMU->mapObject(0x1F9001E8, IOP->SPU2->CORES[0]->VOICES[3]->LSAXH);
			IOP->MMU->mapObject(0x1F9001EA, IOP->SPU2->CORES[0]->VOICES[3]->LSAXL);
			IOP->MMU->mapObject(0x1F9001EC, IOP->SPU2->CORES[0]->VOICES[3]->NAXH);
			IOP->MMU->mapObject(0x1F9001EE, IOP->SPU2->CORES[0]->VOICES[3]->NAXL);
			IOP->MMU->mapObject(0x1F9001F0, IOP->SPU2->CORES[0]->VOICES[4]->SSAH);
			IOP->MMU->mapObject(0x1F9001F2, IOP->SPU2->CORES[0]->VOICES[4]->SSAL);
			IOP->MMU->mapObject(0x1F9001F4, IOP->SPU2->CORES[0]->VOICES[4]->LSAXH);
			IOP->MMU->mapObject(0x1F9001F6, IOP->SPU2->CORES[0]->VOICES[4]->LSAXL);
			IOP->MMU->mapObject(0x1F9001F8, IOP->SPU2->CORES[0]->VOICES[4]->NAXH);
			IOP->MMU->mapObject(0x1F9001FA, IOP->SPU2->CORES[0]->VOICES[4]->NAXL);
			IOP->MMU->mapObject(0x1F9001FC, IOP->SPU2->CORES[0]->VOICES[5]->SSAH);
			IOP->MMU->mapObject(0x1F9001FE, IOP->SPU2->CORES[0]->VOICES[5]->SSAL);
			IOP->MMU->mapObject(0x1F900200, IOP->SPU2->CORES[0]->VOICES[5]->LSAXH);
			IOP->MMU->mapObject(0x1F900202, IOP->SPU2->CORES[0]->VOICES[5]->LSAXL);
			IOP->MMU->mapObject(0x1F900204, IOP->SPU2->CORES[0]->VOICES[5]->NAXH);
			IOP->MMU->mapObject(0x1F900206, IOP->SPU2->CORES[0]->VOICES[5]->NAXL);
			IOP->MMU->mapObject(0x1F900208, IOP->SPU2->CORES[0]->VOICES[6]->SSAH);
			IOP->MMU->mapObject(0x1F90020A, IOP->SPU2->CORES[0]->VOICES[6]->SSAL);
			IOP->MMU->mapObject(0x1F90020C, IOP->SPU2->CORES[0]->VOICES[6]->LSAXH);
			IOP->MMU->mapObject(0x1F90020E, IOP->SPU2->CORES[0]->VOICES[6]->LSAXL);
			IOP->MMU->mapObject(0x1F900210, IOP->SPU2->CORES[0]->VOICES[6]->NAXH);
			IOP->MMU->mapObject(0x1F900212, IOP->SPU2->CORES[0]->VOICES[6]->NAXL);
			IOP->MMU->mapObject(0x1F900214, IOP->SPU2->CORES[0]->VOICES[7]->SSAH);
			IOP->MMU->mapObject(0x1F900216, IOP->SPU2->CORES[0]->VOICES[7]->SSAL);
			IOP->MMU->mapObject(0x1F900218, IOP->SPU2->CORES[0]->VOICES[7]->LSAXH);
			IOP->MMU->mapObject(0x1F90021A, IOP->SPU2->CORES[0]->VOICES[7]->LSAXL);
			IOP->MMU->mapObject(0x1F90021C, IOP->SPU2->CORES[0]->VOICES[7]->NAXH);
			IOP->MMU->mapObject(0x1F90021E, IOP->SPU2->CORES[0]->VOICES[7]->NAXL);
			IOP->MMU->mapObject(0x1F900220, IOP->SPU2->CORES[0]->VOICES[8]->SSAH);
			IOP->MMU->mapObject(0x1F900222, IOP->SPU2->CORES[0]->VOICES[8]->SSAL);
			IOP->MMU->mapObject(0x1F900224, IOP->SPU2->CORES[0]->VOICES[8]->LSAXH);
			IOP->MMU->mapObject(0x1F900226, IOP->SPU2->CORES[0]->VOICES[8]->LSAXL);
			IOP->MMU->mapObject(0x1F900228, IOP->SPU2->CORES[0]->VOICES[8]->NAXH);
			IOP->MMU->mapObject(0x1F90022A, IOP->SPU2->CORES[0]->VOICES[8]->NAXL);
			IOP->MMU->mapObject(0x1F90022C, IOP->SPU2->CORES[0]->VOICES[9]->SSAH);
			IOP->MMU->mapObject(0x1F90022E, IOP->SPU2->CORES[0]->VOICES[9]->SSAL);
			IOP->MMU->mapObject(0x1F900230, IOP->SPU2->CORES[0]->VOICES[9]->LSAXH);
			IOP->MMU->mapObject(0x1F900232, IOP->SPU2->CORES[0]->VOICES[9]->LSAXL);
			IOP->MMU->mapObject(0x1F900234, IOP->SPU2->CORES[0]->VOICES[9]->NAXH);
			IOP->MMU->mapObject(0x1F900236, IOP->SPU2->CORES[0]->VOICES[9]->NAXL);
			IOP->MMU->mapObject(0x1F900238, IOP->SPU2->CORES[0]->VOICES[10]->SSAH);
			IOP->MMU->mapObject(0x1F90023A, IOP->SPU2->CORES[0]->VOICES[10]->SSAL);
			IOP->MMU->mapObject(0x1F90023C, IOP->SPU2->CORES[0]->VOICES[10]->LSAXH);
			IOP->MMU->mapObject(0x1F90023E, IOP->SPU2->CORES[0]->VOICES[10]->LSAXL);
			IOP->MMU->mapObject(0x1F900240, IOP->SPU2->CORES[0]->VOICES[10]->NAXH);
			IOP->MMU->mapObject(0x1F900242, IOP->SPU2->CORES[0]->VOICES[10]->NAXL);
			IOP->MMU->mapObject(0x1F900244, IOP->SPU2->CORES[0]->VOICES[11]->SSAH);
			IOP->MMU->mapObject(0x1F900246, IOP->SPU2->CORES[0]->VOICES[11]->SSAL);
			IOP->MMU->mapObject(0x1F900248, IOP->SPU2->CORES[0]->VOICES[11]->LSAXH);
			IOP->MMU->mapObject(0x1F90024A, IOP->SPU2->CORES[0]->VOICES[11]->LSAXL);
			IOP->MMU->mapObject(0x1F90024C, IOP->SPU2->CORES[0]->VOICES[11]->NAXH);
			IOP->MMU->mapObject(0x1F90024E, IOP->SPU2->CORES[0]->VOICES[11]->NAXL);
			IOP->MMU->mapObject(0x1F900250, IOP->SPU2->CORES[0]->VOICES[12]->SSAH);
			IOP->MMU->mapObject(0x1F900252, IOP->SPU2->CORES[0]->VOICES[12]->SSAL);
			IOP->MMU->mapObject(0x1F900254, IOP->SPU2->CORES[0]->VOICES[12]->LSAXH);
			IOP->MMU->mapObject(0x1F900256, IOP->SPU2->CORES[0]->VOICES[12]->LSAXL);
			IOP->MMU->mapObject(0x1F900258, IOP->SPU2->CORES[0]->VOICES[12]->NAXH);
			IOP->MMU->mapObject(0x1F90025A, IOP->SPU2->CORES[0]->VOICES[12]->NAXL);
			IOP->MMU->mapObject(0x1F90025C, IOP->SPU2->CORES[0]->VOICES[13]->SSAH);
			IOP->MMU->mapObject(0x1F90025E, IOP->SPU2->CORES[0]->VOICES[13]->SSAL);
			IOP->MMU->mapObject(0x1F900260, IOP->SPU2->CORES[0]->VOICES[13]->LSAXH);
			IOP->MMU->mapObject(0x1F900262, IOP->SPU2->CORES[0]->VOICES[13]->LSAXL);
			IOP->MMU->mapObject(0x1F900264, IOP->SPU2->CORES[0]->VOICES[13]->NAXH);
			IOP->MMU->mapObject(0x1F900266, IOP->SPU2->CORES[0]->VOICES[13]->NAXL);
			IOP->MMU->mapObject(0x1F900268, IOP->SPU2->CORES[0]->VOICES[14]->SSAH);
			IOP->MMU->mapObject(0x1F90026A, IOP->SPU2->CORES[0]->VOICES[14]->SSAL);
			IOP->MMU->mapObject(0x1F90026C, IOP->SPU2->CORES[0]->VOICES[14]->LSAXH);
			IOP->MMU->mapObject(0x1F90026E, IOP->SPU2->CORES[0]->VOICES[14]->LSAXL);
			IOP->MMU->mapObject(0x1F900270, IOP->SPU2->CORES[0]->VOICES[14]->NAXH);
			IOP->MMU->mapObject(0x1F900272, IOP->SPU2->CORES[0]->VOICES[14]->NAXL);
			IOP->MMU->mapObject(0x1F900274, IOP->SPU2->CORES[0]->VOICES[15]->SSAH);
			IOP->MMU->mapObject(0x1F900276, IOP->SPU2->CORES[0]->VOICES[15]->SSAL);
			IOP->MMU->mapObject(0x1F900278, IOP->SPU2->CORES[0]->VOICES[15]->LSAXH);
			IOP->MMU->mapObject(0x1F90027A, IOP->SPU2->CORES[0]->VOICES[15]->LSAXL);
			IOP->MMU->mapObject(0x1F90027C, IOP->SPU2->CORES[0]->VOICES[15]->NAXH);
			IOP->MMU->mapObject(0x1F90027E, IOP->SPU2->CORES[0]->VOICES[15]->NAXL);
			IOP->MMU->mapObject(0x1F900280, IOP->SPU2->CORES[0]->VOICES[16]->SSAH);
			IOP->MMU->mapObject(0x1F900282, IOP->SPU2->CORES[0]->VOICES[16]->SSAL);
			IOP->MMU->mapObject(0x1F900284, IOP->SPU2->CORES[0]->VOICES[16]->LSAXH);
			IOP->MMU->mapObject(0x1F900286, IOP->SPU2->CORES[0]->VOICES[16]->LSAXL);
			IOP->MMU->mapObject(0x1F900288, IOP->SPU2->CORES[0]->VOICES[16]->NAXH);
			IOP->MMU->mapObject(0x1F90028A, IOP->SPU2->CORES[0]->VOICES[16]->NAXL);
			IOP->MMU->mapObject(0x1F90028C, IOP->SPU2->CORES[0]->VOICES[17]->SSAH);
			IOP->MMU->mapObject(0x1F90028E, IOP->SPU2->CORES[0]->VOICES[17]->SSAL);
			IOP->MMU->mapObject(0x1F900290, IOP->SPU2->CORES[0]->VOICES[17]->LSAXH);
			IOP->MMU->mapObject(0x1F900292, IOP->SPU2->CORES[0]->VOICES[17]->LSAXL);
			IOP->MMU->mapObject(0x1F900294, IOP->SPU2->CORES[0]->VOICES[17]->NAXH);
			IOP->MMU->mapObject(0x1F900296, IOP->SPU2->CORES[0]->VOICES[17]->NAXL);
			IOP->MMU->mapObject(0x1F900298, IOP->SPU2->CORES[0]->VOICES[18]->SSAH);
			IOP->MMU->mapObject(0x1F90029A, IOP->SPU2->CORES[0]->VOICES[18]->SSAL);
			IOP->MMU->mapObject(0x1F90029C, IOP->SPU2->CORES[0]->VOICES[18]->LSAXH);
			IOP->MMU->mapObject(0x1F90029E, IOP->SPU2->CORES[0]->VOICES[18]->LSAXL);
			IOP->MMU->mapObject(0x1F9002A0, IOP->SPU2->CORES[0]->VOICES[18]->NAXH);
			IOP->MMU->mapObject(0x1F9002A2, IOP->SPU2->CORES[0]->VOICES[18]->NAXL);
			IOP->MMU->mapObject(0x1F9002A4, IOP->SPU2->CORES[0]->VOICES[19]->SSAH);
			IOP->MMU->mapObject(0x1F9002A6, IOP->SPU2->CORES[0]->VOICES[19]->SSAL);
			IOP->MMU->mapObject(0x1F9002A8, IOP->SPU2->CORES[0]->VOICES[19]->LSAXH);
			IOP->MMU->mapObject(0x1F9002AA, IOP->SPU2->CORES[0]->VOICES[19]->LSAXL);
			IOP->MMU->mapObject(0x1F9002AC, IOP->SPU2->CORES[0]->VOICES[19]->NAXH);
			IOP->MMU->mapObject(0x1F9002AE, IOP->SPU2->CORES[0]->VOICES[19]->NAXL);
			IOP->MMU->mapObject(0x1F9002B0, IOP->SPU2->CORES[0]->VOICES[20]->SSAH);
			IOP->MMU->mapObject(0x1F9002B2, IOP->SPU2->CORES[0]->VOICES[20]->SSAL);
			IOP->MMU->mapObject(0x1F9002B4, IOP->SPU2->CORES[0]->VOICES[20]->LSAXH);
			IOP->MMU->mapObject(0x1F9002B6, IOP->SPU2->CORES[0]->VOICES[20]->LSAXL);
			IOP->MMU->mapObject(0x1F9002B8, IOP->SPU2->CORES[0]->VOICES[20]->NAXH);
			IOP->MMU->mapObject(0x1F9002BA, IOP->SPU2->CORES[0]->VOICES[20]->NAXL);
			IOP->MMU->mapObject(0x1F9002BC, IOP->SPU2->CORES[0]->VOICES[21]->SSAH);
			IOP->MMU->mapObject(0x1F9002BE, IOP->SPU2->CORES[0]->VOICES[21]->SSAL);
			IOP->MMU->mapObject(0x1F9002C0, IOP->SPU2->CORES[0]->VOICES[21]->LSAXH);
			IOP->MMU->mapObject(0x1F9002C2, IOP->SPU2->CORES[0]->VOICES[21]->LSAXL);
			IOP->MMU->mapObject(0x1F9002C4, IOP->SPU2->CORES[0]->VOICES[21]->NAXH);
			IOP->MMU->mapObject(0x1F9002C6, IOP->SPU2->CORES[0]->VOICES[21]->NAXL);
			IOP->MMU->mapObject(0x1F9002C8, IOP->SPU2->CORES[0]->VOICES[22]->SSAH);
			IOP->MMU->mapObject(0x1F9002CA, IOP->SPU2->CORES[0]->VOICES[22]->SSAL);
			IOP->MMU->mapObject(0x1F9002CC, IOP->SPU2->CORES[0]->VOICES[22]->LSAXH);
			IOP->MMU->mapObject(0x1F9002CE, IOP->SPU2->CORES[0]->VOICES[22]->LSAXL);
			IOP->MMU->mapObject(0x1F9002D0, IOP->SPU2->CORES[0]->VOICES[22]->NAXH);
			IOP->MMU->mapObject(0x1F9002D2, IOP->SPU2->CORES[0]->VOICES[22]->NAXL);
			IOP->MMU->mapObject(0x1F9002D4, IOP->SPU2->CORES[0]->VOICES[23]->SSAH);
			IOP->MMU->mapObject(0x1F9002D6, IOP->SPU2->CORES[0]->VOICES[23]->SSAL);
			IOP->MMU->mapObject(0x1F9002D8, IOP->SPU2->CORES[0]->VOICES[23]->LSAXH);
			IOP->MMU->mapObject(0x1F9002DA, IOP->SPU2->CORES[0]->VOICES[23]->LSAXL);
			IOP->MMU->mapObject(0x1F9002DC, IOP->SPU2->CORES[0]->VOICES[23]->NAXH);
			IOP->MMU->mapObject(0x1F9002DE, IOP->SPU2->CORES[0]->VOICES[23]->NAXL);
			IOP->MMU->mapObject(0x1F9002E0, IOP->SPU2->CORES[0]->ESAH);
			IOP->MMU->mapObject(0x1F9002E2, IOP->SPU2->CORES[0]->ESAL);
			IOP->MMU->mapObject(0x1F9002E4, IOP->SPU2->CORES[0]->APF1_SIZEH);
			IOP->MMU->mapObject(0x1F9002E6, IOP->SPU2->CORES[0]->APF1_SIZEL);
			IOP->MMU->mapObject(0x1F9002E8, IOP->SPU2->CORES[0]->APF2_SIZEH);
			IOP->MMU->mapObject(0x1F9002EA, IOP->SPU2->CORES[0]->APF2_SIZEL);
			IOP->MMU->mapObject(0x1F9002EC, IOP->SPU2->CORES[0]->SAME_L_DSTH);
			IOP->MMU->mapObject(0x1F9002EE, IOP->SPU2->CORES[0]->SAME_L_DSTL);
			IOP->MMU->mapObject(0x1F9002F0, IOP->SPU2->CORES[0]->SAME_R_DSTH);
			IOP->MMU->mapObject(0x1F9002F2, IOP->SPU2->CORES[0]->SAME_R_DSTL);
			IOP->MMU->mapObject(0x1F9002F4, IOP->SPU2->CORES[0]->COMB1_L_SRCH);
			IOP->MMU->mapObject(0x1F9002F6, IOP->SPU2->CORES[0]->COMB1_L_SRCL);
			IOP->MMU->mapObject(0x1F9002F8, IOP->SPU2->CORES[0]->COMB1_R_SRCH);
			IOP->MMU->mapObject(0x1F9002FA, IOP->SPU2->CORES[0]->COMB1_R_SRCL);
			IOP->MMU->mapObject(0x1F9002FC, IOP->SPU2->CORES[0]->COMB2_L_SRCH);
			IOP->MMU->mapObject(0x1F9002FE, IOP->SPU2->CORES[0]->COMB2_L_SRCL);
			IOP->MMU->mapObject(0x1F900300, IOP->SPU2->CORES[0]->COMB2_R_SRCH);
			IOP->MMU->mapObject(0x1F900302, IOP->SPU2->CORES[0]->COMB2_R_SRCL);
			IOP->MMU->mapObject(0x1F900304, IOP->SPU2->CORES[0]->SAME_L_SRCH);
			IOP->MMU->mapObject(0x1F900306, IOP->SPU2->CORES[0]->SAME_L_SRCL);
			IOP->MMU->mapObject(0x1F900308, IOP->SPU2->CORES[0]->SAME_R_SRCH);
			IOP->MMU->mapObject(0x1F90030A, IOP->SPU2->CORES[0]->SAME_R_SRCL);
			IOP->MMU->mapObject(0x1F90030C, IOP->SPU2->CORES[0]->DIFF_L_DSTH);
			IOP->MMU->mapObject(0x1F90030E, IOP->SPU2->CORES[0]->DIFF_L_DSTL);
			IOP->MMU->mapObject(0x1F900310, IOP->SPU2->CORES[0]->DIFF_R_DSTH);
			IOP->MMU->mapObject(0x1F900312, IOP->SPU2->CORES[0]->DIFF_R_DSTL);
			IOP->MMU->mapObject(0x1F900314, IOP->SPU2->CORES[0]->COMB3_L_SRCH);
			IOP->MMU->mapObject(0x1F900316, IOP->SPU2->CORES[0]->COMB3_L_SRCL);
			IOP->MMU->mapObject(0x1F900318, IOP->SPU2->CORES[0]->COMB3_R_SRCH);
			IOP->MMU->mapObject(0x1F90031A, IOP->SPU2->CORES[0]->COMB3_R_SRCL);
			IOP->MMU->mapObject(0x1F90031C, IOP->SPU2->CORES[0]->COMB4_L_SRCH);
			IOP->MMU->mapObject(0x1F90031E, IOP->SPU2->CORES[0]->COMB4_L_SRCL);
			IOP->MMU->mapObject(0x1F900320, IOP->SPU2->CORES[0]->COMB4_R_SRCH);
			IOP->MMU->mapObject(0x1F900322, IOP->SPU2->CORES[0]->COMB4_R_SRCL);
			IOP->MMU->mapObject(0x1F900324, IOP->SPU2->CORES[0]->DIFF_L_SRCH);
			IOP->MMU->mapObject(0x1F900326, IOP->SPU2->CORES[0]->DIFF_L_SRCL);
			IOP->MMU->mapObject(0x1F900328, IOP->SPU2->CORES[0]->DIFF_R_SRCH);
			IOP->MMU->mapObject(0x1F90032A, IOP->SPU2->CORES[0]->DIFF_R_SRCL);
			IOP->MMU->mapObject(0x1F90032C, IOP->SPU2->CORES[0]->APF1_L_DSTH);
			IOP->MMU->mapObject(0x1F90032E, IOP->SPU2->CORES[0]->APF1_L_DSTL);
			IOP->MMU->mapObject(0x1F900330, IOP->SPU2->CORES[0]->APF1_R_DSTH);
			IOP->MMU->mapObject(0x1F900332, IOP->SPU2->CORES[0]->APF1_R_DSTL);
			IOP->MMU->mapObject(0x1F900334, IOP->SPU2->CORES[0]->APF2_L_DSTH);
			IOP->MMU->mapObject(0x1F900336, IOP->SPU2->CORES[0]->APF2_L_DSTL);
			IOP->MMU->mapObject(0x1F900338, IOP->SPU2->CORES[0]->APF2_R_DSTH);
			IOP->MMU->mapObject(0x1F90033A, IOP->SPU2->CORES[0]->APF2_R_DSTL);
			IOP->MMU->mapObject(0x1F90033C, IOP->SPU2->CORES[0]->EEAH);
			IOP->MMU->mapObject(0x1F90033E, IOP->SPU2->CORES[0]->EEAL);
			...
			IOP->MMU->mapObject(0x1F900400, IOP->SPU2->CORES[1]->VOICES[0]->VOLL);
			IOP->MMU->mapObject(0x1F900402, IOP->SPU2->CORES[1]->VOICES[0]->VOLR);
			IOP->MMU->mapObject(0x1F900404, IOP->SPU2->CORES[1]->VOICES[0]->PITCH);
			IOP->MMU->mapObject(0x1F900406, IOP->SPU2->CORES[1]->VOICES[0]->ADSR1);
			IOP->MMU->mapObject(0x1F900408, IOP->SPU2->CORES[1]->VOICES[0]->ADSR2);
			IOP->MMU->mapObject(0x1F90040A, IOP->SPU2->CORES[1]->VOICES[0]->ENVX);
			IOP->MMU->mapObject(0x1F90040C, IOP->SPU2->CORES[1]->VOICES[0]->VOLXL);
			IOP->MMU->mapObject(0x1F90040E, IOP->SPU2->CORES[1]->VOICES[0]->VOLXR);
			IOP->MMU->mapObject(0x1F900410, IOP->SPU2->CORES[1]->VOICES[1]->VOLL);
			IOP->MMU->mapObject(0x1F900412, IOP->SPU2->CORES[1]->VOICES[1]->VOLR);
			IOP->MMU->mapObject(0x1F900414, IOP->SPU2->CORES[1]->VOICES[1]->PITCH);
			IOP->MMU->mapObject(0x1F900416, IOP->SPU2->CORES[1]->VOICES[1]->ADSR1);
			IOP->MMU->mapObject(0x1F900418, IOP->SPU2->CORES[1]->VOICES[1]->ADSR2);
			IOP->MMU->mapObject(0x1F90041A, IOP->SPU2->CORES[1]->VOICES[1]->ENVX);
			IOP->MMU->mapObject(0x1F90041C, IOP->SPU2->CORES[1]->VOICES[1]->VOLXL);
			IOP->MMU->mapObject(0x1F90041E, IOP->SPU2->CORES[1]->VOICES[1]->VOLXR);
			IOP->MMU->mapObject(0x1F900420, IOP->SPU2->CORES[1]->VOICES[2]->VOLL);
			IOP->MMU->mapObject(0x1F900422, IOP->SPU2->CORES[1]->VOICES[2]->VOLR);
			IOP->MMU->mapObject(0x1F900424, IOP->SPU2->CORES[1]->VOICES[2]->PITCH);
			IOP->MMU->mapObject(0x1F900426, IOP->SPU2->CORES[1]->VOICES[2]->ADSR1);
			IOP->MMU->mapObject(0x1F900428, IOP->SPU2->CORES[1]->VOICES[2]->ADSR2);
			IOP->MMU->mapObject(0x1F90042A, IOP->SPU2->CORES[1]->VOICES[2]->ENVX);
			IOP->MMU->mapObject(0x1F90042C, IOP->SPU2->CORES[1]->VOICES[2]->VOLXL);
			IOP->MMU->mapObject(0x1F90042E, IOP->SPU2->CORES[1]->VOICES[2]->VOLXR);
			IOP->MMU->mapObject(0x1F900430, IOP->SPU2->CORES[1]->VOICES[3]->VOLL);
			IOP->MMU->mapObject(0x1F900432, IOP->SPU2->CORES[1]->VOICES[3]->VOLR);
			IOP->MMU->mapObject(0x1F900434, IOP->SPU2->CORES[1]->VOICES[3]->PITCH);
			IOP->MMU->mapObject(0x1F900436, IOP->SPU2->CORES[1]->VOICES[3]->ADSR1);
			IOP->MMU->mapObject(0x1F900438, IOP->SPU2->CORES[1]->VOICES[3]->ADSR2);
			IOP->MMU->mapObject(0x1F90043A, IOP->SPU2->CORES[1]->VOICES[3]->ENVX);
			IOP->MMU->mapObject(0x1F90043C, IOP->SPU2->CORES[1]->VOICES[3]->VOLXL);
			IOP->MMU->mapObject(0x1F90043E, IOP->SPU2->CORES[1]->VOICES[3]->VOLXR);
			IOP->MMU->mapObject(0x1F900440, IOP->SPU2->CORES[1]->VOICES[4]->VOLL);
			IOP->MMU->mapObject(0x1F900442, IOP->SPU2->CORES[1]->VOICES[4]->VOLR);
			IOP->MMU->mapObject(0x1F900444, IOP->SPU2->CORES[1]->VOICES[4]->PITCH);
			IOP->MMU->mapObject(0x1F900446, IOP->SPU2->CORES[1]->VOICES[4]->ADSR1);
			IOP->MMU->mapObject(0x1F900448, IOP->SPU2->CORES[1]->VOICES[4]->ADSR2);
			IOP->MMU->mapObject(0x1F90044A, IOP->SPU2->CORES[1]->VOICES[4]->ENVX);
			IOP->MMU->mapObject(0x1F90044C, IOP->SPU2->CORES[1]->VOICES[4]->VOLXL);
			IOP->MMU->mapObject(0x1F90044E, IOP->SPU2->CORES[1]->VOICES[4]->VOLXR);
			IOP->MMU->mapObject(0x1F900450, IOP->SPU2->CORES[1]->VOICES[5]->VOLL);
			IOP->MMU->mapObject(0x1F900452, IOP->SPU2->CORES[1]->VOICES[5]->VOLR);
			IOP->MMU->mapObject(0x1F900454, IOP->SPU2->CORES[1]->VOICES[5]->PITCH);
			IOP->MMU->mapObject(0x1F900456, IOP->SPU2->CORES[1]->VOICES[5]->ADSR1);
			IOP->MMU->mapObject(0x1F900458, IOP->SPU2->CORES[1]->VOICES[5]->ADSR2);
			IOP->MMU->mapObject(0x1F90045A, IOP->SPU2->CORES[1]->VOICES[5]->ENVX);
			IOP->MMU->mapObject(0x1F90045C, IOP->SPU2->CORES[1]->VOICES[5]->VOLXL);
			IOP->MMU->mapObject(0x1F90045E, IOP->SPU2->CORES[1]->VOICES[5]->VOLXR);
			IOP->MMU->mapObject(0x1F900460, IOP->SPU2->CORES[1]->VOICES[6]->VOLL);
			IOP->MMU->mapObject(0x1F900462, IOP->SPU2->CORES[1]->VOICES[6]->VOLR);
			IOP->MMU->mapObject(0x1F900464, IOP->SPU2->CORES[1]->VOICES[6]->PITCH);
			IOP->MMU->mapObject(0x1F900466, IOP->SPU2->CORES[1]->VOICES[6]->ADSR1);
			IOP->MMU->mapObject(0x1F900468, IOP->SPU2->CORES[1]->VOICES[6]->ADSR2);
			IOP->MMU->mapObject(0x1F90046A, IOP->SPU2->CORES[1]->VOICES[6]->ENVX);
			IOP->MMU->mapObject(0x1F90046C, IOP->SPU2->CORES[1]->VOICES[6]->VOLXL);
			IOP->MMU->mapObject(0x1F90046E, IOP->SPU2->CORES[1]->VOICES[6]->VOLXR);
			IOP->MMU->mapObject(0x1F900470, IOP->SPU2->CORES[1]->VOICES[7]->VOLL);
			IOP->MMU->mapObject(0x1F900472, IOP->SPU2->CORES[1]->VOICES[7]->VOLR);
			IOP->MMU->mapObject(0x1F900474, IOP->SPU2->CORES[1]->VOICES[7]->PITCH);
			IOP->MMU->mapObject(0x1F900476, IOP->SPU2->CORES[1]->VOICES[7]->ADSR1);
			IOP->MMU->mapObject(0x1F900478, IOP->SPU2->CORES[1]->VOICES[7]->ADSR2);
			IOP->MMU->mapObject(0x1F90047A, IOP->SPU2->CORES[1]->VOICES[7]->ENVX);
			IOP->MMU->mapObject(0x1F90047C, IOP->SPU2->CORES[1]->VOICES[7]->VOLXL);
			IOP->MMU->mapObject(0x1F90047E, IOP->SPU2->CORES[1]->VOICES[7]->VOLXR);
			IOP->MMU->mapObject(0x1F900480, IOP->SPU2->CORES[1]->VOICES[8]->VOLL);
			IOP->MMU->mapObject(0x1F900482, IOP->SPU2->CORES[1]->VOICES[8]->VOLR);
			IOP->MMU->mapObject(0x1F900484, IOP->SPU2->CORES[1]->VOICES[8]->PITCH);
			IOP->MMU->mapObject(0x1F900486, IOP->SPU2->CORES[1]->VOICES[8]->ADSR1);
			IOP->MMU->mapObject(0x1F900488, IOP->SPU2->CORES[1]->VOICES[8]->ADSR2);
			IOP->MMU->mapObject(0x1F90048A, IOP->SPU2->CORES[1]->VOICES[8]->ENVX);
			IOP->MMU->mapObject(0x1F90048C, IOP->SPU2->CORES[1]->VOICES[8]->VOLXL);
			IOP->MMU->mapObject(0x1F90048E, IOP->SPU2->CORES[1]->VOICES[8]->VOLXR);
			IOP->MMU->mapObject(0x1F900490, IOP->SPU2->CORES[1]->VOICES[9]->VOLL);
			IOP->MMU->mapObject(0x1F900492, IOP->SPU2->CORES[1]->VOICES[9]->VOLR);
			IOP->MMU->mapObject(0x1F900494, IOP->SPU2->CORES[1]->VOICES[9]->PITCH);
			IOP->MMU->mapObject(0x1F900496, IOP->SPU2->CORES[1]->VOICES[9]->ADSR1);
			IOP->MMU->mapObject(0x1F900498, IOP->SPU2->CORES[1]->VOICES[9]->ADSR2);
			IOP->MMU->mapObject(0x1F90049A, IOP->SPU2->CORES[1]->VOICES[9]->ENVX);
			IOP->MMU->mapObject(0x1F90049C, IOP->SPU2->CORES[1]->VOICES[9]->VOLXL);
			IOP->MMU->mapObject(0x1F90049E, IOP->SPU2->CORES[1]->VOICES[9]->VOLXR);
			IOP->MMU->mapObject(0x1F9004A0, IOP->SPU2->CORES[1]->VOICES[10]->VOLL);
			IOP->MMU->mapObject(0x1F9004A2, IOP->SPU2->CORES[1]->VOICES[10]->VOLR);
			IOP->MMU->mapObject(0x1F9004A4, IOP->SPU2->CORES[1]->VOICES[10]->PITCH);
			IOP->MMU->mapObject(0x1F9004A6, IOP->SPU2->CORES[1]->VOICES[10]->ADSR1);
			IOP->MMU->mapObject(0x1F9004A8, IOP->SPU2->CORES[1]->VOICES[10]->ADSR2);
			IOP->MMU->mapObject(0x1F9004AA, IOP->SPU2->CORES[1]->VOICES[10]->ENVX);
			IOP->MMU->mapObject(0x1F9004AC, IOP->SPU2->CORES[1]->VOICES[10]->VOLXL);
			IOP->MMU->mapObject(0x1F9004AE, IOP->SPU2->CORES[1]->VOICES[10]->VOLXR);
			IOP->MMU->mapObject(0x1F9004B0, IOP->SPU2->CORES[1]->VOICES[11]->VOLL);
			IOP->MMU->mapObject(0x1F9004B2, IOP->SPU2->CORES[1]->VOICES[11]->VOLR);
			IOP->MMU->mapObject(0x1F9004B4, IOP->SPU2->CORES[1]->VOICES[11]->PITCH);
			IOP->MMU->mapObject(0x1F9004B6, IOP->SPU2->CORES[1]->VOICES[11]->ADSR1);
			IOP->MMU->mapObject(0x1F9004B8, IOP->SPU2->CORES[1]->VOICES[11]->ADSR2);
			IOP->MMU->mapObject(0x1F9004BA, IOP->SPU2->CORES[1]->VOICES[11]->ENVX);
			IOP->MMU->mapObject(0x1F9004BC, IOP->SPU2->CORES[1]->VOICES[11]->VOLXL);
			IOP->MMU->mapObject(0x1F9004BE, IOP->SPU2->CORES[1]->VOICES[11]->VOLXR);
			IOP->MMU->mapObject(0x1F9004C0, IOP->SPU2->CORES[1]->VOICES[12]->VOLL);
			IOP->MMU->mapObject(0x1F9004C2, IOP->SPU2->CORES[1]->VOICES[12]->VOLR);
			IOP->MMU->mapObject(0x1F9004C4, IOP->SPU2->CORES[1]->VOICES[12]->PITCH);
			IOP->MMU->mapObject(0x1F9004C6, IOP->SPU2->CORES[1]->VOICES[12]->ADSR1);
			IOP->MMU->mapObject(0x1F9004C8, IOP->SPU2->CORES[1]->VOICES[12]->ADSR2);
			IOP->MMU->mapObject(0x1F9004CA, IOP->SPU2->CORES[1]->VOICES[12]->ENVX);
			IOP->MMU->mapObject(0x1F9004CC, IOP->SPU2->CORES[1]->VOICES[12]->VOLXL);
			IOP->MMU->mapObject(0x1F9004CE, IOP->SPU2->CORES[1]->VOICES[12]->VOLXR);
			IOP->MMU->mapObject(0x1F9004D0, IOP->SPU2->CORES[1]->VOICES[13]->VOLL);
			IOP->MMU->mapObject(0x1F9004D2, IOP->SPU2->CORES[1]->VOICES[13]->VOLR);
			IOP->MMU->mapObject(0x1F9004D4, IOP->SPU2->CORES[1]->VOICES[13]->PITCH);
			IOP->MMU->mapObject(0x1F9004D6, IOP->SPU2->CORES[1]->VOICES[13]->ADSR1);
			IOP->MMU->mapObject(0x1F9004D8, IOP->SPU2->CORES[1]->VOICES[13]->ADSR2);
			IOP->MMU->mapObject(0x1F9004DA, IOP->SPU2->CORES[1]->VOICES[13]->ENVX);
			IOP->MMU->mapObject(0x1F9004DC, IOP->SPU2->CORES[1]->VOICES[13]->VOLXL);
			IOP->MMU->mapObject(0x1F9004DE, IOP->SPU2->CORES[1]->VOICES[13]->VOLXR);
			IOP->MMU->mapObject(0x1F9004E0, IOP->SPU2->CORES[1]->VOICES[14]->VOLL);
			IOP->MMU->mapObject(0x1F9004E2, IOP->SPU2->CORES[1]->VOICES[14]->VOLR);
			IOP->MMU->mapObject(0x1F9004E4, IOP->SPU2->CORES[1]->VOICES[14]->PITCH);
			IOP->MMU->mapObject(0x1F9004E6, IOP->SPU2->CORES[1]->VOICES[14]->ADSR1);
			IOP->MMU->mapObject(0x1F9004E8, IOP->SPU2->CORES[1]->VOICES[14]->ADSR2);
			IOP->MMU->mapObject(0x1F9004EA, IOP->SPU2->CORES[1]->VOICES[14]->ENVX);
			IOP->MMU->mapObject(0x1F9004EC, IOP->SPU2->CORES[1]->VOICES[14]->VOLXL);
			IOP->MMU->mapObject(0x1F9004EE, IOP->SPU2->CORES[1]->VOICES[14]->VOLXR);
			IOP->MMU->mapObject(0x1F9004F0, IOP->SPU2->CORES[1]->VOICES[15]->VOLL);
			IOP->MMU->mapObject(0x1F9004F2, IOP->SPU2->CORES[1]->VOICES[15]->VOLR);
			IOP->MMU->mapObject(0x1F9004F4, IOP->SPU2->CORES[1]->VOICES[15]->PITCH);
			IOP->MMU->mapObject(0x1F9004F6, IOP->SPU2->CORES[1]->VOICES[15]->ADSR1);
			IOP->MMU->mapObject(0x1F9004F8, IOP->SPU2->CORES[1]->VOICES[15]->ADSR2);
			IOP->MMU->mapObject(0x1F9004FA, IOP->SPU2->CORES[1]->VOICES[15]->ENVX);
			IOP->MMU->mapObject(0x1F9004FC, IOP->SPU2->CORES[1]->VOICES[15]->VOLXL);
			IOP->MMU->mapObject(0x1F9004FE, IOP->SPU2->CORES[1]->VOICES[15]->VOLXR);
			IOP->MMU->mapObject(0x1F900500, IOP->SPU2->CORES[1]->VOICES[16]->VOLL);
			IOP->MMU->mapObject(0x1F900502, IOP->SPU2->CORES[1]->VOICES[16]->VOLR);
			IOP->MMU->mapObject(0x1F900504, IOP->SPU2->CORES[1]->VOICES[16]->PITCH);
			IOP->MMU->mapObject(0x1F900506, IOP->SPU2->CORES[1]->VOICES[16]->ADSR1);
			IOP->MMU->mapObject(0x1F900508, IOP->SPU2->CORES[1]->VOICES[16]->ADSR2);
			IOP->MMU->mapObject(0x1F90050A, IOP->SPU2->CORES[1]->VOICES[16]->ENVX);
			IOP->MMU->mapObject(0x1F90050C, IOP->SPU2->CORES[1]->VOICES[16]->VOLXL);
			IOP->MMU->mapObject(0x1F90050E, IOP->SPU2->CORES[1]->VOICES[16]->VOLXR);
			IOP->MMU->mapObject(0x1F900510, IOP->SPU2->CORES[1]->VOICES[17]->VOLL);
			IOP->MMU->mapObject(0x1F900512, IOP->SPU2->CORES[1]->VOICES[17]->VOLR);
			IOP->MMU->mapObject(0x1F900514, IOP->SPU2->CORES[1]->VOICES[17]->PITCH);
			IOP->MMU->mapObject(0x1F900516, IOP->SPU2->CORES[1]->VOICES[17]->ADSR1);
			IOP->MMU->mapObject(0x1F900518, IOP->SPU2->CORES[1]->VOICES[17]->ADSR2);
			IOP->MMU->mapObject(0x1F90051A, IOP->SPU2->CORES[1]->VOICES[17]->ENVX);
			IOP->MMU->mapObject(0x1F90051C, IOP->SPU2->CORES[1]->VOICES[17]->VOLXL);
			IOP->MMU->mapObject(0x1F90051E, IOP->SPU2->CORES[1]->VOICES[17]->VOLXR);
			IOP->MMU->mapObject(0x1F900520, IOP->SPU2->CORES[1]->VOICES[18]->VOLL);
			IOP->MMU->mapObject(0x1F900522, IOP->SPU2->CORES[1]->VOICES[18]->VOLR);
			IOP->MMU->mapObject(0x1F900524, IOP->SPU2->CORES[1]->VOICES[18]->PITCH);
			IOP->MMU->mapObject(0x1F900526, IOP->SPU2->CORES[1]->VOICES[18]->ADSR1);
			IOP->MMU->mapObject(0x1F900528, IOP->SPU2->CORES[1]->VOICES[18]->ADSR2);
			IOP->MMU->mapObject(0x1F90052A, IOP->SPU2->CORES[1]->VOICES[18]->ENVX);
			IOP->MMU->mapObject(0x1F90052C, IOP->SPU2->CORES[1]->VOICES[18]->VOLXL);
			IOP->MMU->mapObject(0x1F90052E, IOP->SPU2->CORES[1]->VOICES[18]->VOLXR);
			IOP->MMU->mapObject(0x1F900530, IOP->SPU2->CORES[1]->VOICES[19]->VOLL);
			IOP->MMU->mapObject(0x1F900532, IOP->SPU2->CORES[1]->VOICES[19]->VOLR);
			IOP->MMU->mapObject(0x1F900534, IOP->SPU2->CORES[1]->VOICES[19]->PITCH);
			IOP->MMU->mapObject(0x1F900536, IOP->SPU2->CORES[1]->VOICES[19]->ADSR1);
			IOP->MMU->mapObject(0x1F900538, IOP->SPU2->CORES[1]->VOICES[19]->ADSR2);
			IOP->MMU->mapObject(0x1F90053A, IOP->SPU2->CORES[1]->VOICES[19]->ENVX);
			IOP->MMU->mapObject(0x1F90053C, IOP->SPU2->CORES[1]->VOICES[19]->VOLXL);
			IOP->MMU->mapObject(0x1F90053E, IOP->SPU2->CORES[1]->VOICES[19]->VOLXR);
			IOP->MMU->mapObject(0x1F900540, IOP->SPU2->CORES[1]->VOICES[20]->VOLL);
			IOP->MMU->mapObject(0x1F900542, IOP->SPU2->CORES[1]->VOICES[20]->VOLR);
			IOP->MMU->mapObject(0x1F900544, IOP->SPU2->CORES[1]->VOICES[20]->PITCH);
			IOP->MMU->mapObject(0x1F900546, IOP->SPU2->CORES[1]->VOICES[20]->ADSR1);
			IOP->MMU->mapObject(0x1F900548, IOP->SPU2->CORES[1]->VOICES[20]->ADSR2);
			IOP->MMU->mapObject(0x1F90054A, IOP->SPU2->CORES[1]->VOICES[20]->ENVX);
			IOP->MMU->mapObject(0x1F90054C, IOP->SPU2->CORES[1]->VOICES[20]->VOLXL);
			IOP->MMU->mapObject(0x1F90054E, IOP->SPU2->CORES[1]->VOICES[20]->VOLXR);
			IOP->MMU->mapObject(0x1F900550, IOP->SPU2->CORES[1]->VOICES[21]->VOLL);
			IOP->MMU->mapObject(0x1F900552, IOP->SPU2->CORES[1]->VOICES[21]->VOLR);
			IOP->MMU->mapObject(0x1F900554, IOP->SPU2->CORES[1]->VOICES[21]->PITCH);
			IOP->MMU->mapObject(0x1F900556, IOP->SPU2->CORES[1]->VOICES[21]->ADSR1);
			IOP->MMU->mapObject(0x1F900558, IOP->SPU2->CORES[1]->VOICES[21]->ADSR2);
			IOP->MMU->mapObject(0x1F90055A, IOP->SPU2->CORES[1]->VOICES[21]->ENVX);
			IOP->MMU->mapObject(0x1F90055C, IOP->SPU2->CORES[1]->VOICES[21]->VOLXL);
			IOP->MMU->mapObject(0x1F90055E, IOP->SPU2->CORES[1]->VOICES[21]->VOLXR);
			IOP->MMU->mapObject(0x1F900560, IOP->SPU2->CORES[1]->VOICES[22]->VOLL);
			IOP->MMU->mapObject(0x1F900562, IOP->SPU2->CORES[1]->VOICES[22]->VOLR);
			IOP->MMU->mapObject(0x1F900564, IOP->SPU2->CORES[1]->VOICES[22]->PITCH);
			IOP->MMU->mapObject(0x1F900566, IOP->SPU2->CORES[1]->VOICES[22]->ADSR1);
			IOP->MMU->mapObject(0x1F900568, IOP->SPU2->CORES[1]->VOICES[22]->ADSR2);
			IOP->MMU->mapObject(0x1F90056A, IOP->SPU2->CORES[1]->VOICES[22]->ENVX);
			IOP->MMU->mapObject(0x1F90056C, IOP->SPU2->CORES[1]->VOICES[22]->VOLXL);
			IOP->MMU->mapObject(0x1F90056E, IOP->SPU2->CORES[1]->VOICES[22]->VOLXR);
			IOP->MMU->mapObject(0x1F900570, IOP->SPU2->CORES[1]->VOICES[23]->VOLL);
			IOP->MMU->mapObject(0x1F900572, IOP->SPU2->CORES[1]->VOICES[23]->VOLR);
			IOP->MMU->mapObject(0x1F900574, IOP->SPU2->CORES[1]->VOICES[23]->PITCH);
			IOP->MMU->mapObject(0x1F900576, IOP->SPU2->CORES[1]->VOICES[23]->ADSR1);
			IOP->MMU->mapObject(0x1F900578, IOP->SPU2->CORES[1]->VOICES[23]->ADSR2);
			IOP->MMU->mapObject(0x1F90057A, IOP->SPU2->CORES[1]->VOICES[23]->ENVX);
			IOP->MMU->mapObject(0x1F90057C, IOP->SPU2->CORES[1]->VOICES[23]->VOLXL);
			IOP->MMU->mapObject(0x1F90057E, IOP->SPU2->CORES[1]->VOICES[23]->VOLXR);
			IOP->MMU->mapObject(0x1F900580, IOP->SPU2->CORES[1]->PMON0);
			IOP->MMU->mapObject(0x1F900582, IOP->SPU2->CORES[1]->PMON1);
			IOP->MMU->mapObject(0x1F900584, IOP->SPU2->CORES[1]->NON0);
			IOP->MMU->mapObject(0x1F900586, IOP->SPU2->CORES[1]->NON1);
			IOP->MMU->mapObject(0x1F900588, IOP->SPU2->CORES[1]->VMIXL0);
			IOP->MMU->mapObject(0x1F90058A, IOP->SPU2->CORES[1]->VMIXL1);
			IOP->MMU->mapObject(0x1F90058C, IOP->SPU2->CORES[1]->VMIXEL0);
			IOP->MMU->mapObject(0x1F90058E, IOP->SPU2->CORES[1]->VMIXEL1);
			IOP->MMU->mapObject(0x1F900590, IOP->SPU2->CORES[1]->VMIXR0);
			IOP->MMU->mapObject(0x1F900592, IOP->SPU2->CORES[1]->VMIXR1);
			IOP->MMU->mapObject(0x1F900594, IOP->SPU2->CORES[1]->VMIXER0);
			IOP->MMU->mapObject(0x1F900596, IOP->SPU2->CORES[1]->VMIXER1);
			IOP->MMU->mapObject(0x1F900598, IOP->SPU2->CORES[1]->MMIX);
			IOP->MMU->mapObject(0x1F90059A, IOP->SPU2->CORES[1]->ATTR);
			IOP->MMU->mapObject(0x1F90059C, IOP->SPU2->CORES[1]->IRQAH);
			IOP->MMU->mapObject(0x1F90059E, IOP->SPU2->CORES[1]->IRQAL);
			IOP->MMU->mapObject(0x1F9005A0, IOP->SPU2->CORES[1]->KON0);
			IOP->MMU->mapObject(0x1F9005A2, IOP->SPU2->CORES[1]->KON1);
			IOP->MMU->mapObject(0x1F9005A4, IOP->SPU2->CORES[1]->KOF0);
			IOP->MMU->mapObject(0x1F9005A6, IOP->SPU2->CORES[1]->KOF1);
			IOP->MMU->mapObject(0x1F9005A8, IOP->SPU2->CORES[1]->TSAH);
			IOP->MMU->mapObject(0x1F9005AA, IOP->SPU2->CORES[1]->TSAL);
			IOP->MMU->mapObject(0x1F9005AC, IOP->SPU2->CORES[1]->DATA0);
			IOP->MMU->mapObject(0x1F9005AE, IOP->SPU2->CORES[1]->DATA1);
			IOP->MMU->mapObject(0x1F9005B0, IOP->SPU2->CORES[1]->DATA2);
			IOP->MMU->mapObject(0x1F9005C0, IOP->SPU2->CORES[1]->VOICES[0]->SSAH);
			IOP->MMU->mapObject(0x1F9005C2, IOP->SPU2->CORES[1]->VOICES[0]->SSAL);
			IOP->MMU->mapObject(0x1F9005C4, IOP->SPU2->CORES[1]->VOICES[0]->LSAXH);
			IOP->MMU->mapObject(0x1F9005C6, IOP->SPU2->CORES[1]->VOICES[0]->LSAXL);
			IOP->MMU->mapObject(0x1F9005C8, IOP->SPU2->CORES[1]->VOICES[0]->NAXH);
			IOP->MMU->mapObject(0x1F9005CA, IOP->SPU2->CORES[1]->VOICES[0]->NAXL);
			IOP->MMU->mapObject(0x1F9005CC, IOP->SPU2->CORES[1]->VOICES[1]->SSAH);
			IOP->MMU->mapObject(0x1F9005CE, IOP->SPU2->CORES[1]->VOICES[1]->SSAL);
			IOP->MMU->mapObject(0x1F9005D0, IOP->SPU2->CORES[1]->VOICES[1]->LSAXH);
			IOP->MMU->mapObject(0x1F9005D2, IOP->SPU2->CORES[1]->VOICES[1]->LSAXL);
			IOP->MMU->mapObject(0x1F9005D4, IOP->SPU2->CORES[1]->VOICES[1]->NAXH);
			IOP->MMU->mapObject(0x1F9005D6, IOP->SPU2->CORES[1]->VOICES[1]->NAXL);
			IOP->MMU->mapObject(0x1F9005D8, IOP->SPU2->CORES[1]->VOICES[2]->SSAH);
			IOP->MMU->mapObject(0x1F9005DA, IOP->SPU2->CORES[1]->VOICES[2]->SSAL);
			IOP->MMU->mapObject(0x1F9005DC, IOP->SPU2->CORES[1]->VOICES[2]->LSAXH);
			IOP->MMU->mapObject(0x1F9005DE, IOP->SPU2->CORES[1]->VOICES[2]->LSAXL);
			IOP->MMU->mapObject(0x1F9005E0, IOP->SPU2->CORES[1]->VOICES[2]->NAXH);
			IOP->MMU->mapObject(0x1F9005E2, IOP->SPU2->CORES[1]->VOICES[2]->NAXL);
			IOP->MMU->mapObject(0x1F9005E4, IOP->SPU2->CORES[1]->VOICES[3]->SSAH);
			IOP->MMU->mapObject(0x1F9005E6, IOP->SPU2->CORES[1]->VOICES[3]->SSAL);
			IOP->MMU->mapObject(0x1F9005E8, IOP->SPU2->CORES[1]->VOICES[3]->LSAXH);
			IOP->MMU->mapObject(0x1F9005EA, IOP->SPU2->CORES[1]->VOICES[3]->LSAXL);
			IOP->MMU->mapObject(0x1F9005EC, IOP->SPU2->CORES[1]->VOICES[3]->NAXH);
			IOP->MMU->mapObject(0x1F9005EE, IOP->SPU2->CORES[1]->VOICES[3]->NAXL);
			IOP->MMU->mapObject(0x1F9005F0, IOP->SPU2->CORES[1]->VOICES[4]->SSAH);
			IOP->MMU->mapObject(0x1F9005F2, IOP->SPU2->CORES[1]->VOICES[4]->SSAL);
			IOP->MMU->mapObject(0x1F9005F4, IOP->SPU2->CORES[1]->VOICES[4]->LSAXH);
			IOP->MMU->mapObject(0x1F9005F6, IOP->SPU2->CORES[1]->VOICES[4]->LSAXL);
			IOP->MMU->mapObject(0x1F9005F8, IOP->SPU2->CORES[1]->VOICES[4]->NAXH);
			IOP->MMU->mapObject(0x1F9005FA, IOP->SPU2->CORES[1]->VOICES[4]->NAXL);
			IOP->MMU->mapObject(0x1F9005FC, IOP->SPU2->CORES[1]->VOICES[5]->SSAH);
			IOP->MMU->mapObject(0x1F9005FE, IOP->SPU2->CORES[1]->VOICES[5]->SSAL);
			IOP->MMU->mapObject(0x1F900600, IOP->SPU2->CORES[1]->VOICES[5]->LSAXH);
			IOP->MMU->mapObject(0x1F900602, IOP->SPU2->CORES[1]->VOICES[5]->LSAXL);
			IOP->MMU->mapObject(0x1F900604, IOP->SPU2->CORES[1]->VOICES[5]->NAXH);
			IOP->MMU->mapObject(0x1F900606, IOP->SPU2->CORES[1]->VOICES[5]->NAXL);
			IOP->MMU->mapObject(0x1F900608, IOP->SPU2->CORES[1]->VOICES[6]->SSAH);
			IOP->MMU->mapObject(0x1F90060A, IOP->SPU2->CORES[1]->VOICES[6]->SSAL);
			IOP->MMU->mapObject(0x1F90060C, IOP->SPU2->CORES[1]->VOICES[6]->LSAXH);
			IOP->MMU->mapObject(0x1F90060E, IOP->SPU2->CORES[1]->VOICES[6]->LSAXL);
			IOP->MMU->mapObject(0x1F900610, IOP->SPU2->CORES[1]->VOICES[6]->NAXH);
			IOP->MMU->mapObject(0x1F900612, IOP->SPU2->CORES[1]->VOICES[6]->NAXL);
			IOP->MMU->mapObject(0x1F900614, IOP->SPU2->CORES[1]->VOICES[7]->SSAH);
			IOP->MMU->mapObject(0x1F900616, IOP->SPU2->CORES[1]->VOICES[7]->SSAL);
			IOP->MMU->mapObject(0x1F900618, IOP->SPU2->CORES[1]->VOICES[7]->LSAXH);
			IOP->MMU->mapObject(0x1F90061A, IOP->SPU2->CORES[1]->VOICES[7]->LSAXL);
			IOP->MMU->mapObject(0x1F90061C, IOP->SPU2->CORES[1]->VOICES[7]->NAXH);
			IOP->MMU->mapObject(0x1F90061E, IOP->SPU2->CORES[1]->VOICES[7]->NAXL);
			IOP->MMU->mapObject(0x1F900620, IOP->SPU2->CORES[1]->VOICES[8]->SSAH);
			IOP->MMU->mapObject(0x1F900622, IOP->SPU2->CORES[1]->VOICES[8]->SSAL);
			IOP->MMU->mapObject(0x1F900624, IOP->SPU2->CORES[1]->VOICES[8]->LSAXH);
			IOP->MMU->mapObject(0x1F900626, IOP->SPU2->CORES[1]->VOICES[8]->LSAXL);
			IOP->MMU->mapObject(0x1F900628, IOP->SPU2->CORES[1]->VOICES[8]->NAXH);
			IOP->MMU->mapObject(0x1F90062A, IOP->SPU2->CORES[1]->VOICES[8]->NAXL);
			IOP->MMU->mapObject(0x1F90062C, IOP->SPU2->CORES[1]->VOICES[9]->SSAH);
			IOP->MMU->mapObject(0x1F90062E, IOP->SPU2->CORES[1]->VOICES[9]->SSAL);
			IOP->MMU->mapObject(0x1F900630, IOP->SPU2->CORES[1]->VOICES[9]->LSAXH);
			IOP->MMU->mapObject(0x1F900632, IOP->SPU2->CORES[1]->VOICES[9]->LSAXL);
			IOP->MMU->mapObject(0x1F900634, IOP->SPU2->CORES[1]->VOICES[9]->NAXH);
			IOP->MMU->mapObject(0x1F900636, IOP->SPU2->CORES[1]->VOICES[9]->NAXL);
			IOP->MMU->mapObject(0x1F900638, IOP->SPU2->CORES[1]->VOICES[10]->SSAH);
			IOP->MMU->mapObject(0x1F90063A, IOP->SPU2->CORES[1]->VOICES[10]->SSAL);
			IOP->MMU->mapObject(0x1F90063C, IOP->SPU2->CORES[1]->VOICES[10]->LSAXH);
			IOP->MMU->mapObject(0x1F90063E, IOP->SPU2->CORES[1]->VOICES[10]->LSAXL);
			IOP->MMU->mapObject(0x1F900640, IOP->SPU2->CORES[1]->VOICES[10]->NAXH);
			IOP->MMU->mapObject(0x1F900642, IOP->SPU2->CORES[1]->VOICES[10]->NAXL);
			IOP->MMU->mapObject(0x1F900644, IOP->SPU2->CORES[1]->VOICES[11]->SSAH);
			IOP->MMU->mapObject(0x1F900646, IOP->SPU2->CORES[1]->VOICES[11]->SSAL);
			IOP->MMU->mapObject(0x1F900648, IOP->SPU2->CORES[1]->VOICES[11]->LSAXH);
			IOP->MMU->mapObject(0x1F90064A, IOP->SPU2->CORES[1]->VOICES[11]->LSAXL);
			IOP->MMU->mapObject(0x1F90064C, IOP->SPU2->CORES[1]->VOICES[11]->NAXH);
			IOP->MMU->mapObject(0x1F90064E, IOP->SPU2->CORES[1]->VOICES[11]->NAXL);
			IOP->MMU->mapObject(0x1F900650, IOP->SPU2->CORES[1]->VOICES[12]->SSAH);
			IOP->MMU->mapObject(0x1F900652, IOP->SPU2->CORES[1]->VOICES[12]->SSAL);
			IOP->MMU->mapObject(0x1F900654, IOP->SPU2->CORES[1]->VOICES[12]->LSAXH);
			IOP->MMU->mapObject(0x1F900656, IOP->SPU2->CORES[1]->VOICES[12]->LSAXL);
			IOP->MMU->mapObject(0x1F900658, IOP->SPU2->CORES[1]->VOICES[12]->NAXH);
			IOP->MMU->mapObject(0x1F90065A, IOP->SPU2->CORES[1]->VOICES[12]->NAXL);
			IOP->MMU->mapObject(0x1F90065C, IOP->SPU2->CORES[1]->VOICES[13]->SSAH);
			IOP->MMU->mapObject(0x1F90065E, IOP->SPU2->CORES[1]->VOICES[13]->SSAL);
			IOP->MMU->mapObject(0x1F900660, IOP->SPU2->CORES[1]->VOICES[13]->LSAXH);
			IOP->MMU->mapObject(0x1F900662, IOP->SPU2->CORES[1]->VOICES[13]->LSAXL);
			IOP->MMU->mapObject(0x1F900664, IOP->SPU2->CORES[1]->VOICES[13]->NAXH);
			IOP->MMU->mapObject(0x1F900666, IOP->SPU2->CORES[1]->VOICES[13]->NAXL);
			IOP->MMU->mapObject(0x1F900668, IOP->SPU2->CORES[1]->VOICES[14]->SSAH);
			IOP->MMU->mapObject(0x1F90066A, IOP->SPU2->CORES[1]->VOICES[14]->SSAL);
			IOP->MMU->mapObject(0x1F90066C, IOP->SPU2->CORES[1]->VOICES[14]->LSAXH);
			IOP->MMU->mapObject(0x1F90066E, IOP->SPU2->CORES[1]->VOICES[14]->LSAXL);
			IOP->MMU->mapObject(0x1F900670, IOP->SPU2->CORES[1]->VOICES[14]->NAXH);
			IOP->MMU->mapObject(0x1F900672, IOP->SPU2->CORES[1]->VOICES[14]->NAXL);
			IOP->MMU->mapObject(0x1F900674, IOP->SPU2->CORES[1]->VOICES[15]->SSAH);
			IOP->MMU->mapObject(0x1F900676, IOP->SPU2->CORES[1]->VOICES[15]->SSAL);
			IOP->MMU->mapObject(0x1F900678, IOP->SPU2->CORES[1]->VOICES[15]->LSAXH);
			IOP->MMU->mapObject(0x1F90067A, IOP->SPU2->CORES[1]->VOICES[15]->LSAXL);
			IOP->MMU->mapObject(0x1F90067C, IOP->SPU2->CORES[1]->VOICES[15]->NAXH);
			IOP->MMU->mapObject(0x1F90067E, IOP->SPU2->CORES[1]->VOICES[15]->NAXL);
			IOP->MMU->mapObject(0x1F900680, IOP->SPU2->CORES[1]->VOICES[16]->SSAH);
			IOP->MMU->mapObject(0x1F900682, IOP->SPU2->CORES[1]->VOICES[16]->SSAL);
			IOP->MMU->mapObject(0x1F900684, IOP->SPU2->CORES[1]->VOICES[16]->LSAXH);
			IOP->MMU->mapObject(0x1F900686, IOP->SPU2->CORES[1]->VOICES[16]->LSAXL);
			IOP->MMU->mapObject(0x1F900688, IOP->SPU2->CORES[1]->VOICES[16]->NAXH);
			IOP->MMU->mapObject(0x1F90068A, IOP->SPU2->CORES[1]->VOICES[16]->NAXL);
			IOP->MMU->mapObject(0x1F90068C, IOP->SPU2->CORES[1]->VOICES[17]->SSAH);
			IOP->MMU->mapObject(0x1F90068E, IOP->SPU2->CORES[1]->VOICES[17]->SSAL);
			IOP->MMU->mapObject(0x1F900690, IOP->SPU2->CORES[1]->VOICES[17]->LSAXH);
			IOP->MMU->mapObject(0x1F900692, IOP->SPU2->CORES[1]->VOICES[17]->LSAXL);
			IOP->MMU->mapObject(0x1F900694, IOP->SPU2->CORES[1]->VOICES[17]->NAXH);
			IOP->MMU->mapObject(0x1F900696, IOP->SPU2->CORES[1]->VOICES[17]->NAXL);
			IOP->MMU->mapObject(0x1F900698, IOP->SPU2->CORES[1]->VOICES[18]->SSAH);
			IOP->MMU->mapObject(0x1F90069A, IOP->SPU2->CORES[1]->VOICES[18]->SSAL);
			IOP->MMU->mapObject(0x1F90069C, IOP->SPU2->CORES[1]->VOICES[18]->LSAXH);
			IOP->MMU->mapObject(0x1F90069E, IOP->SPU2->CORES[1]->VOICES[18]->LSAXL);
			IOP->MMU->mapObject(0x1F9006A0, IOP->SPU2->CORES[1]->VOICES[18]->NAXH);
			IOP->MMU->mapObject(0x1F9006A2, IOP->SPU2->CORES[1]->VOICES[18]->NAXL);
			IOP->MMU->mapObject(0x1F9006A4, IOP->SPU2->CORES[1]->VOICES[19]->SSAH);
			IOP->MMU->mapObject(0x1F9006A6, IOP->SPU2->CORES[1]->VOICES[19]->SSAL);
			IOP->MMU->mapObject(0x1F9006A8, IOP->SPU2->CORES[1]->VOICES[19]->LSAXH);
			IOP->MMU->mapObject(0x1F9006AA, IOP->SPU2->CORES[1]->VOICES[19]->LSAXL);
			IOP->MMU->mapObject(0x1F9006AC, IOP->SPU2->CORES[1]->VOICES[19]->NAXH);
			IOP->MMU->mapObject(0x1F9006AE, IOP->SPU2->CORES[1]->VOICES[19]->NAXL);
			IOP->MMU->mapObject(0x1F9006B0, IOP->SPU2->CORES[1]->VOICES[20]->SSAH);
			IOP->MMU->mapObject(0x1F9006B2, IOP->SPU2->CORES[1]->VOICES[20]->SSAL);
			IOP->MMU->mapObject(0x1F9006B4, IOP->SPU2->CORES[1]->VOICES[20]->LSAXH);
			IOP->MMU->mapObject(0x1F9006B6, IOP->SPU2->CORES[1]->VOICES[20]->LSAXL);
			IOP->MMU->mapObject(0x1F9006B8, IOP->SPU2->CORES[1]->VOICES[20]->NAXH);
			IOP->MMU->mapObject(0x1F9006BA, IOP->SPU2->CORES[1]->VOICES[20]->NAXL);
			IOP->MMU->mapObject(0x1F9006BC, IOP->SPU2->CORES[1]->VOICES[21]->SSAH);
			IOP->MMU->mapObject(0x1F9006BE, IOP->SPU2->CORES[1]->VOICES[21]->SSAL);
			IOP->MMU->mapObject(0x1F9006C0, IOP->SPU2->CORES[1]->VOICES[21]->LSAXH);
			IOP->MMU->mapObject(0x1F9006C2, IOP->SPU2->CORES[1]->VOICES[21]->LSAXL);
			IOP->MMU->mapObject(0x1F9006C4, IOP->SPU2->CORES[1]->VOICES[21]->NAXH);
			IOP->MMU->mapObject(0x1F9006C6, IOP->SPU2->CORES[1]->VOICES[21]->NAXL);
			IOP->MMU->mapObject(0x1F9006C8, IOP->SPU2->CORES[1]->VOICES[22]->SSAH);
			IOP->MMU->mapObject(0x1F9006CA, IOP->SPU2->CORES[1]->VOICES[22]->SSAL);
			IOP->MMU->mapObject(0x1F9006CC, IOP->SPU2->CORES[1]->VOICES[22]->LSAXH);
			IOP->MMU->mapObject(0x1F9006CE, IOP->SPU2->CORES[1]->VOICES[22]->LSAXL);
			IOP->MMU->mapObject(0x1F9006D0, IOP->SPU2->CORES[1]->VOICES[22]->NAXH);
			IOP->MMU->mapObject(0x1F9006D2, IOP->SPU2->CORES[1]->VOICES[22]->NAXL);
			IOP->MMU->mapObject(0x1F9006D4, IOP->SPU2->CORES[1]->VOICES[23]->SSAH);
			IOP->MMU->mapObject(0x1F9006D6, IOP->SPU2->CORES[1]->VOICES[23]->SSAL);
			IOP->MMU->mapObject(0x1F9006D8, IOP->SPU2->CORES[1]->VOICES[23]->LSAXH);
			IOP->MMU->mapObject(0x1F9006DA, IOP->SPU2->CORES[1]->VOICES[23]->LSAXL);
			IOP->MMU->mapObject(0x1F9006DC, IOP->SPU2->CORES[1]->VOICES[23]->NAXH);
			IOP->MMU->mapObject(0x1F9006DE, IOP->SPU2->CORES[1]->VOICES[23]->NAXL);
			IOP->MMU->mapObject(0x1F9006E0, IOP->SPU2->CORES[1]->ESAH);
			IOP->MMU->mapObject(0x1F9006E2, IOP->SPU2->CORES[1]->ESAL);
			IOP->MMU->mapObject(0x1F9006E4, IOP->SPU2->CORES[1]->APF1_SIZEH);
			IOP->MMU->mapObject(0x1F9006E6, IOP->SPU2->CORES[1]->APF1_SIZEL);
			IOP->MMU->mapObject(0x1F9006E8, IOP->SPU2->CORES[1]->APF2_SIZEH);
			IOP->MMU->mapObject(0x1F9006EA, IOP->SPU2->CORES[1]->APF2_SIZEL);
			IOP->MMU->mapObject(0x1F9006EC, IOP->SPU2->CORES[1]->SAME_L_DSTH);
			IOP->MMU->mapObject(0x1F9006EE, IOP->SPU2->CORES[1]->SAME_L_DSTL);
			IOP->MMU->mapObject(0x1F9006F0, IOP->SPU2->CORES[1]->SAME_R_DSTH);
			IOP->MMU->mapObject(0x1F9006F2, IOP->SPU2->CORES[1]->SAME_R_DSTL);
			IOP->MMU->mapObject(0x1F9006F4, IOP->SPU2->CORES[1]->COMB1_L_SRCH);
			IOP->MMU->mapObject(0x1F9006F6, IOP->SPU2->CORES[1]->COMB1_L_SRCL);
			IOP->MMU->mapObject(0x1F9006F8, IOP->SPU2->CORES[1]->COMB1_R_SRCH);
			IOP->MMU->mapObject(0x1F9006FA, IOP->SPU2->CORES[1]->COMB1_R_SRCL);
			IOP->MMU->mapObject(0x1F9006FC, IOP->SPU2->CORES[1]->COMB2_L_SRCH);
			IOP->MMU->mapObject(0x1F9006FE, IOP->SPU2->CORES[1]->COMB2_L_SRCL);
			IOP->MMU->mapObject(0x1F900700, IOP->SPU2->CORES[1]->COMB2_R_SRCH);
			IOP->MMU->mapObject(0x1F900702, IOP->SPU2->CORES[1]->COMB2_R_SRCL);
			IOP->MMU->mapObject(0x1F900704, IOP->SPU2->CORES[1]->SAME_L_SRCH);
			IOP->MMU->mapObject(0x1F900706, IOP->SPU2->CORES[1]->SAME_L_SRCL);
			IOP->MMU->mapObject(0x1F900708, IOP->SPU2->CORES[1]->SAME_R_SRCH);
			IOP->MMU->mapObject(0x1F90070A, IOP->SPU2->CORES[1]->SAME_R_SRCL);
			IOP->MMU->mapObject(0x1F90070C, IOP->SPU2->CORES[1]->DIFF_L_DSTH);
			IOP->MMU->mapObject(0x1F90070E, IOP->SPU2->CORES[1]->DIFF_L_DSTL);
			IOP->MMU->mapObject(0x1F900710, IOP->SPU2->CORES[1]->DIFF_R_DSTH);
			IOP->MMU->mapObject(0x1F900712, IOP->SPU2->CORES[1]->DIFF_R_DSTL);
			IOP->MMU->mapObject(0x1F900714, IOP->SPU2->CORES[1]->COMB3_L_SRCH);
			IOP->MMU->mapObject(0x1F900716, IOP->SPU2->CORES[1]->COMB3_L_SRCL);
			IOP->MMU->mapObject(0x1F900718, IOP->SPU2->CORES[1]->COMB3_R_SRCH);
			IOP->MMU->mapObject(0x1F90071A, IOP->SPU2->CORES[1]->COMB3_R_SRCL);
			IOP->MMU->mapObject(0x1F90071C, IOP->SPU2->CORES[1]->COMB4_L_SRCH);
			IOP->MMU->mapObject(0x1F90071E, IOP->SPU2->CORES[1]->COMB4_L_SRCL);
			IOP->MMU->mapObject(0x1F900720, IOP->SPU2->CORES[1]->COMB4_R_SRCH);
			IOP->MMU->mapObject(0x1F900722, IOP->SPU2->CORES[1]->COMB4_R_SRCL);
			IOP->MMU->mapObject(0x1F900724, IOP->SPU2->CORES[1]->DIFF_L_SRCH);
			IOP->MMU->mapObject(0x1F900726, IOP->SPU2->CORES[1]->DIFF_L_SRCL);
			IOP->MMU->mapObject(0x1F900728, IOP->SPU2->CORES[1]->DIFF_R_SRCH);
			IOP->MMU->mapObject(0x1F90072A, IOP->SPU2->CORES[1]->DIFF_R_SRCL);
			IOP->MMU->mapObject(0x1F90072C, IOP->SPU2->CORES[1]->APF1_L_DSTH);
			IOP->MMU->mapObject(0x1F90072E, IOP->SPU2->CORES[1]->APF1_L_DSTL);
			IOP->MMU->mapObject(0x1F900730, IOP->SPU2->CORES[1]->APF1_R_DSTH);
			IOP->MMU->mapObject(0x1F900732, IOP->SPU2->CORES[1]->APF1_R_DSTL);
			IOP->MMU->mapObject(0x1F900734, IOP->SPU2->CORES[1]->APF2_L_DSTH);
			IOP->MMU->mapObject(0x1F900736, IOP->SPU2->CORES[1]->APF2_L_DSTL);
			IOP->MMU->mapObject(0x1F900738, IOP->SPU2->CORES[1]->APF2_R_DSTH);
			IOP->MMU->mapObject(0x1F90073A, IOP->SPU2->CORES[1]->APF2_R_DSTL);
			IOP->MMU->mapObject(0x1F90073C, IOP->SPU2->CORES[1]->EEAH);
			IOP->MMU->mapObject(0x1F90073E, IOP->SPU2->CORES[1]->EEAL);
			IOP->MMU->mapObject(0x1F900740, IOP->SPU2->CORES[1]->ENDX0);
			IOP->MMU->mapObject(0x1F900742, IOP->SPU2->CORES[1]->ENDX1);
			IOP->MMU->mapObject(0x1F900744, IOP->SPU2->CORES[1]->STATX);
			IOP->MMU->mapObject(0x1F900746, IOP->SPU2->CORES[1]->MEMORY_0X46);

			// SPU2 Registers Mirror.
			IOP->MMU->mapObject(0x1F900B46, IOP->SPU2->CORES[0]->MEMORY_0X46);
