...
void Resources_t::postInit_IOP() const
{
	// Initalise physical memory map of IOP.
	{
		...
		// IOP Registers.
		{
			...
			IOP->MMU->mapObject(0x1F90059C, IOP->SPU2->CORES[1]->IRQAL);
			IOP->MMU->mapObject(0x1F90059E, IOP->SPU2->CORES[1]->IRQAH);
			...
			IOP->MMU->mapObject(0x1F9005A8, IOP->SPU2->CORES[1]->TSAL);
			IOP->MMU->mapObject(0x1F9005AA, IOP->SPU2->CORES[1]->TSAH);
			...
			IOP->MMU->mapObject(0x1F9005C0, IOP->SPU2->CORES[1]->VOICES[0]->SSAL);
			IOP->MMU->mapObject(0x1F9005C2, IOP->SPU2->CORES[1]->VOICES[0]->SSAH);
			IOP->MMU->mapObject(0x1F9005C4, IOP->SPU2->CORES[1]->VOICES[0]->LSAXL);
			IOP->MMU->mapObject(0x1F9005C6, IOP->SPU2->CORES[1]->VOICES[0]->LSAXH);
			IOP->MMU->mapObject(0x1F9005C8, IOP->SPU2->CORES[1]->VOICES[0]->NAXL);
			IOP->MMU->mapObject(0x1F9005CA, IOP->SPU2->CORES[1]->VOICES[0]->NAXH);
			IOP->MMU->mapObject(0x1F9005CC, IOP->SPU2->CORES[1]->VOICES[1]->SSAL);
			IOP->MMU->mapObject(0x1F9005CE, IOP->SPU2->CORES[1]->VOICES[1]->SSAH);
			IOP->MMU->mapObject(0x1F9005D0, IOP->SPU2->CORES[1]->VOICES[1]->LSAXL);
			IOP->MMU->mapObject(0x1F9005D2, IOP->SPU2->CORES[1]->VOICES[1]->LSAXH);
			IOP->MMU->mapObject(0x1F9005D4, IOP->SPU2->CORES[1]->VOICES[1]->NAXL);
			IOP->MMU->mapObject(0x1F9005D6, IOP->SPU2->CORES[1]->VOICES[1]->NAXH);
			IOP->MMU->mapObject(0x1F9005D8, IOP->SPU2->CORES[1]->VOICES[2]->SSAL);
			IOP->MMU->mapObject(0x1F9005DA, IOP->SPU2->CORES[1]->VOICES[2]->SSAH);
			IOP->MMU->mapObject(0x1F9005DC, IOP->SPU2->CORES[1]->VOICES[2]->LSAXL);
			IOP->MMU->mapObject(0x1F9005DE, IOP->SPU2->CORES[1]->VOICES[2]->LSAXH);
			IOP->MMU->mapObject(0x1F9005E0, IOP->SPU2->CORES[1]->VOICES[2]->NAXL);
			IOP->MMU->mapObject(0x1F9005E2, IOP->SPU2->CORES[1]->VOICES[2]->NAXH);
			IOP->MMU->mapObject(0x1F9005E4, IOP->SPU2->CORES[1]->VOICES[3]->SSAL);
			IOP->MMU->mapObject(0x1F9005E6, IOP->SPU2->CORES[1]->VOICES[3]->SSAH);
			IOP->MMU->mapObject(0x1F9005E8, IOP->SPU2->CORES[1]->VOICES[3]->LSAXL);
			IOP->MMU->mapObject(0x1F9005EA, IOP->SPU2->CORES[1]->VOICES[3]->LSAXH);
			IOP->MMU->mapObject(0x1F9005EC, IOP->SPU2->CORES[1]->VOICES[3]->NAXL);
			IOP->MMU->mapObject(0x1F9005EE, IOP->SPU2->CORES[1]->VOICES[3]->NAXH);
			IOP->MMU->mapObject(0x1F9005F0, IOP->SPU2->CORES[1]->VOICES[4]->SSAL);
			IOP->MMU->mapObject(0x1F9005F2, IOP->SPU2->CORES[1]->VOICES[4]->SSAH);
			IOP->MMU->mapObject(0x1F9005F4, IOP->SPU2->CORES[1]->VOICES[4]->LSAXL);
			IOP->MMU->mapObject(0x1F9005F6, IOP->SPU2->CORES[1]->VOICES[4]->LSAXH);
			IOP->MMU->mapObject(0x1F9005F8, IOP->SPU2->CORES[1]->VOICES[4]->NAXL);
			IOP->MMU->mapObject(0x1F9005FA, IOP->SPU2->CORES[1]->VOICES[4]->NAXH);
			IOP->MMU->mapObject(0x1F9005FC, IOP->SPU2->CORES[1]->VOICES[5]->SSAL);
			IOP->MMU->mapObject(0x1F9005FE, IOP->SPU2->CORES[1]->VOICES[5]->SSAH);
			IOP->MMU->mapObject(0x1F900600, IOP->SPU2->CORES[1]->VOICES[5]->LSAXL);
			IOP->MMU->mapObject(0x1F900602, IOP->SPU2->CORES[1]->VOICES[5]->LSAXH);
			IOP->MMU->mapObject(0x1F900604, IOP->SPU2->CORES[1]->VOICES[5]->NAXL);
			IOP->MMU->mapObject(0x1F900606, IOP->SPU2->CORES[1]->VOICES[5]->NAXH);
			IOP->MMU->mapObject(0x1F900608, IOP->SPU2->CORES[1]->VOICES[6]->SSAL);
			IOP->MMU->mapObject(0x1F90060A, IOP->SPU2->CORES[1]->VOICES[6]->SSAH);
			IOP->MMU->mapObject(0x1F90060C, IOP->SPU2->CORES[1]->VOICES[6]->LSAXL);
			IOP->MMU->mapObject(0x1F90060E, IOP->SPU2->CORES[1]->VOICES[6]->LSAXH);
			IOP->MMU->mapObject(0x1F900610, IOP->SPU2->CORES[1]->VOICES[6]->NAXL);
			IOP->MMU->mapObject(0x1F900612, IOP->SPU2->CORES[1]->VOICES[6]->NAXH);
			IOP->MMU->mapObject(0x1F900614, IOP->SPU2->CORES[1]->VOICES[7]->SSAL);
			IOP->MMU->mapObject(0x1F900616, IOP->SPU2->CORES[1]->VOICES[7]->SSAH);
			IOP->MMU->mapObject(0x1F900618, IOP->SPU2->CORES[1]->VOICES[7]->LSAXL);
			IOP->MMU->mapObject(0x1F90061A, IOP->SPU2->CORES[1]->VOICES[7]->LSAXH);
			IOP->MMU->mapObject(0x1F90061C, IOP->SPU2->CORES[1]->VOICES[7]->NAXL);
			IOP->MMU->mapObject(0x1F90061E, IOP->SPU2->CORES[1]->VOICES[7]->NAXH);
			IOP->MMU->mapObject(0x1F900620, IOP->SPU2->CORES[1]->VOICES[8]->SSAL);
			IOP->MMU->mapObject(0x1F900622, IOP->SPU2->CORES[1]->VOICES[8]->SSAH);
			IOP->MMU->mapObject(0x1F900624, IOP->SPU2->CORES[1]->VOICES[8]->LSAXL);
			IOP->MMU->mapObject(0x1F900626, IOP->SPU2->CORES[1]->VOICES[8]->LSAXH);
			IOP->MMU->mapObject(0x1F900628, IOP->SPU2->CORES[1]->VOICES[8]->NAXL);
			IOP->MMU->mapObject(0x1F90062A, IOP->SPU2->CORES[1]->VOICES[8]->NAXH);
			IOP->MMU->mapObject(0x1F90062C, IOP->SPU2->CORES[1]->VOICES[9]->SSAL);
			IOP->MMU->mapObject(0x1F90062E, IOP->SPU2->CORES[1]->VOICES[9]->SSAH);
			IOP->MMU->mapObject(0x1F900630, IOP->SPU2->CORES[1]->VOICES[9]->LSAXL);
			IOP->MMU->mapObject(0x1F900632, IOP->SPU2->CORES[1]->VOICES[9]->LSAXH);
			IOP->MMU->mapObject(0x1F900634, IOP->SPU2->CORES[1]->VOICES[9]->NAXL);
			IOP->MMU->mapObject(0x1F900636, IOP->SPU2->CORES[1]->VOICES[9]->NAXH);
			IOP->MMU->mapObject(0x1F900638, IOP->SPU2->CORES[1]->VOICES[10]->SSAL);
			IOP->MMU->mapObject(0x1F90063A, IOP->SPU2->CORES[1]->VOICES[10]->SSAH);
			IOP->MMU->mapObject(0x1F90063C, IOP->SPU2->CORES[1]->VOICES[10]->LSAXL);
			IOP->MMU->mapObject(0x1F90063E, IOP->SPU2->CORES[1]->VOICES[10]->LSAXH);
			IOP->MMU->mapObject(0x1F900640, IOP->SPU2->CORES[1]->VOICES[10]->NAXL);
			IOP->MMU->mapObject(0x1F900642, IOP->SPU2->CORES[1]->VOICES[10]->NAXH);
			IOP->MMU->mapObject(0x1F900644, IOP->SPU2->CORES[1]->VOICES[11]->SSAL);
			IOP->MMU->mapObject(0x1F900646, IOP->SPU2->CORES[1]->VOICES[11]->SSAH);
			IOP->MMU->mapObject(0x1F900648, IOP->SPU2->CORES[1]->VOICES[11]->LSAXL);
			IOP->MMU->mapObject(0x1F90064A, IOP->SPU2->CORES[1]->VOICES[11]->LSAXH);
			IOP->MMU->mapObject(0x1F90064C, IOP->SPU2->CORES[1]->VOICES[11]->NAXL);
			IOP->MMU->mapObject(0x1F90064E, IOP->SPU2->CORES[1]->VOICES[11]->NAXH);
			IOP->MMU->mapObject(0x1F900650, IOP->SPU2->CORES[1]->VOICES[12]->SSAL);
			IOP->MMU->mapObject(0x1F900652, IOP->SPU2->CORES[1]->VOICES[12]->SSAH);
			IOP->MMU->mapObject(0x1F900654, IOP->SPU2->CORES[1]->VOICES[12]->LSAXL);
			IOP->MMU->mapObject(0x1F900656, IOP->SPU2->CORES[1]->VOICES[12]->LSAXH);
			IOP->MMU->mapObject(0x1F900658, IOP->SPU2->CORES[1]->VOICES[12]->NAXL);
			IOP->MMU->mapObject(0x1F90065A, IOP->SPU2->CORES[1]->VOICES[12]->NAXH);
			IOP->MMU->mapObject(0x1F90065C, IOP->SPU2->CORES[1]->VOICES[13]->SSAL);
			IOP->MMU->mapObject(0x1F90065E, IOP->SPU2->CORES[1]->VOICES[13]->SSAH);
			IOP->MMU->mapObject(0x1F900660, IOP->SPU2->CORES[1]->VOICES[13]->LSAXL);
			IOP->MMU->mapObject(0x1F900662, IOP->SPU2->CORES[1]->VOICES[13]->LSAXH);
			IOP->MMU->mapObject(0x1F900664, IOP->SPU2->CORES[1]->VOICES[13]->NAXL);
			IOP->MMU->mapObject(0x1F900666, IOP->SPU2->CORES[1]->VOICES[13]->NAXH);
			IOP->MMU->mapObject(0x1F900668, IOP->SPU2->CORES[1]->VOICES[14]->SSAL);
			IOP->MMU->mapObject(0x1F90066A, IOP->SPU2->CORES[1]->VOICES[14]->SSAH);
			IOP->MMU->mapObject(0x1F90066C, IOP->SPU2->CORES[1]->VOICES[14]->LSAXL);
			IOP->MMU->mapObject(0x1F90066E, IOP->SPU2->CORES[1]->VOICES[14]->LSAXH);
			IOP->MMU->mapObject(0x1F900670, IOP->SPU2->CORES[1]->VOICES[14]->NAXL);
			IOP->MMU->mapObject(0x1F900672, IOP->SPU2->CORES[1]->VOICES[14]->NAXH);
			IOP->MMU->mapObject(0x1F900674, IOP->SPU2->CORES[1]->VOICES[15]->SSAL);
			IOP->MMU->mapObject(0x1F900676, IOP->SPU2->CORES[1]->VOICES[15]->SSAH);
			IOP->MMU->mapObject(0x1F900678, IOP->SPU2->CORES[1]->VOICES[15]->LSAXL);
			IOP->MMU->mapObject(0x1F90067A, IOP->SPU2->CORES[1]->VOICES[15]->LSAXH);
			IOP->MMU->mapObject(0x1F90067C, IOP->SPU2->CORES[1]->VOICES[15]->NAXL);
			IOP->MMU->mapObject(0x1F90067E, IOP->SPU2->CORES[1]->VOICES[15]->NAXH);
			IOP->MMU->mapObject(0x1F900680, IOP->SPU2->CORES[1]->VOICES[16]->SSAL);
			IOP->MMU->mapObject(0x1F900682, IOP->SPU2->CORES[1]->VOICES[16]->SSAH);
			IOP->MMU->mapObject(0x1F900684, IOP->SPU2->CORES[1]->VOICES[16]->LSAXL);
			IOP->MMU->mapObject(0x1F900686, IOP->SPU2->CORES[1]->VOICES[16]->LSAXH);
			IOP->MMU->mapObject(0x1F900688, IOP->SPU2->CORES[1]->VOICES[16]->NAXL);
			IOP->MMU->mapObject(0x1F90068A, IOP->SPU2->CORES[1]->VOICES[16]->NAXH);
			IOP->MMU->mapObject(0x1F90068C, IOP->SPU2->CORES[1]->VOICES[17]->SSAL);
			IOP->MMU->mapObject(0x1F90068E, IOP->SPU2->CORES[1]->VOICES[17]->SSAH);
			IOP->MMU->mapObject(0x1F900690, IOP->SPU2->CORES[1]->VOICES[17]->LSAXL);
			IOP->MMU->mapObject(0x1F900692, IOP->SPU2->CORES[1]->VOICES[17]->LSAXH);
			IOP->MMU->mapObject(0x1F900694, IOP->SPU2->CORES[1]->VOICES[17]->NAXL);
			IOP->MMU->mapObject(0x1F900696, IOP->SPU2->CORES[1]->VOICES[17]->NAXH);
			IOP->MMU->mapObject(0x1F900698, IOP->SPU2->CORES[1]->VOICES[18]->SSAL);
			IOP->MMU->mapObject(0x1F90069A, IOP->SPU2->CORES[1]->VOICES[18]->SSAH);
			IOP->MMU->mapObject(0x1F90069C, IOP->SPU2->CORES[1]->VOICES[18]->LSAXL);
			IOP->MMU->mapObject(0x1F90069E, IOP->SPU2->CORES[1]->VOICES[18]->LSAXH);
			IOP->MMU->mapObject(0x1F9006A0, IOP->SPU2->CORES[1]->VOICES[18]->NAXL);
			IOP->MMU->mapObject(0x1F9006A2, IOP->SPU2->CORES[1]->VOICES[18]->NAXH);
			IOP->MMU->mapObject(0x1F9006A4, IOP->SPU2->CORES[1]->VOICES[19]->SSAL);
			IOP->MMU->mapObject(0x1F9006A6, IOP->SPU2->CORES[1]->VOICES[19]->SSAH);
			IOP->MMU->mapObject(0x1F9006A8, IOP->SPU2->CORES[1]->VOICES[19]->LSAXL);
			IOP->MMU->mapObject(0x1F9006AA, IOP->SPU2->CORES[1]->VOICES[19]->LSAXH);
			IOP->MMU->mapObject(0x1F9006AC, IOP->SPU2->CORES[1]->VOICES[19]->NAXL);
			IOP->MMU->mapObject(0x1F9006AE, IOP->SPU2->CORES[1]->VOICES[19]->NAXH);
			IOP->MMU->mapObject(0x1F9006B0, IOP->SPU2->CORES[1]->VOICES[20]->SSAL);
			IOP->MMU->mapObject(0x1F9006B2, IOP->SPU2->CORES[1]->VOICES[20]->SSAH);
			IOP->MMU->mapObject(0x1F9006B4, IOP->SPU2->CORES[1]->VOICES[20]->LSAXL);
			IOP->MMU->mapObject(0x1F9006B6, IOP->SPU2->CORES[1]->VOICES[20]->LSAXH);
			IOP->MMU->mapObject(0x1F9006B8, IOP->SPU2->CORES[1]->VOICES[20]->NAXL);
			IOP->MMU->mapObject(0x1F9006BA, IOP->SPU2->CORES[1]->VOICES[20]->NAXH);
			IOP->MMU->mapObject(0x1F9006BC, IOP->SPU2->CORES[1]->VOICES[21]->SSAL);
			IOP->MMU->mapObject(0x1F9006BE, IOP->SPU2->CORES[1]->VOICES[21]->SSAH);
			IOP->MMU->mapObject(0x1F9006C0, IOP->SPU2->CORES[1]->VOICES[21]->LSAXL);
			IOP->MMU->mapObject(0x1F9006C2, IOP->SPU2->CORES[1]->VOICES[21]->LSAXH);
			IOP->MMU->mapObject(0x1F9006C4, IOP->SPU2->CORES[1]->VOICES[21]->NAXL);
			IOP->MMU->mapObject(0x1F9006C6, IOP->SPU2->CORES[1]->VOICES[21]->NAXH);
			IOP->MMU->mapObject(0x1F9006C8, IOP->SPU2->CORES[1]->VOICES[22]->SSAL);
			IOP->MMU->mapObject(0x1F9006CA, IOP->SPU2->CORES[1]->VOICES[22]->SSAH);
			IOP->MMU->mapObject(0x1F9006CC, IOP->SPU2->CORES[1]->VOICES[22]->LSAXL);
			IOP->MMU->mapObject(0x1F9006CE, IOP->SPU2->CORES[1]->VOICES[22]->LSAXH);
			IOP->MMU->mapObject(0x1F9006D0, IOP->SPU2->CORES[1]->VOICES[22]->NAXL);
			IOP->MMU->mapObject(0x1F9006D2, IOP->SPU2->CORES[1]->VOICES[22]->NAXH);
			IOP->MMU->mapObject(0x1F9006D4, IOP->SPU2->CORES[1]->VOICES[23]->SSAL);
			IOP->MMU->mapObject(0x1F9006D6, IOP->SPU2->CORES[1]->VOICES[23]->SSAH);
			IOP->MMU->mapObject(0x1F9006D8, IOP->SPU2->CORES[1]->VOICES[23]->LSAXL);
			IOP->MMU->mapObject(0x1F9006DA, IOP->SPU2->CORES[1]->VOICES[23]->LSAXH);
			IOP->MMU->mapObject(0x1F9006DC, IOP->SPU2->CORES[1]->VOICES[23]->NAXL);
			IOP->MMU->mapObject(0x1F9006DE, IOP->SPU2->CORES[1]->VOICES[23]->NAXH);
			IOP->MMU->mapObject(0x1F9006E0, IOP->SPU2->CORES[1]->ESAL);
			IOP->MMU->mapObject(0x1F9006E2, IOP->SPU2->CORES[1]->ESAH);
			IOP->MMU->mapObject(0x1F9006E4, IOP->SPU2->CORES[1]->APF1_SIZEL);
			IOP->MMU->mapObject(0x1F9006E6, IOP->SPU2->CORES[1]->APF1_SIZEH);
			IOP->MMU->mapObject(0x1F9006E8, IOP->SPU2->CORES[1]->APF2_SIZEL);
			IOP->MMU->mapObject(0x1F9006EA, IOP->SPU2->CORES[1]->APF2_SIZEH);
			IOP->MMU->mapObject(0x1F9006EC, IOP->SPU2->CORES[1]->SAME_L_DSTL);
			IOP->MMU->mapObject(0x1F9006EE, IOP->SPU2->CORES[1]->SAME_L_DSTH);
			IOP->MMU->mapObject(0x1F9006F0, IOP->SPU2->CORES[1]->SAME_R_DSTL);
			IOP->MMU->mapObject(0x1F9006F2, IOP->SPU2->CORES[1]->SAME_R_DSTH);
			IOP->MMU->mapObject(0x1F9006F4, IOP->SPU2->CORES[1]->COMB1_L_SRCL);
			IOP->MMU->mapObject(0x1F9006F6, IOP->SPU2->CORES[1]->COMB1_L_SRCH);
			IOP->MMU->mapObject(0x1F9006F8, IOP->SPU2->CORES[1]->COMB1_R_SRCL);
			IOP->MMU->mapObject(0x1F9006FA, IOP->SPU2->CORES[1]->COMB1_R_SRCH);
			IOP->MMU->mapObject(0x1F9006FC, IOP->SPU2->CORES[1]->COMB2_L_SRCL);
			IOP->MMU->mapObject(0x1F9006FE, IOP->SPU2->CORES[1]->COMB2_L_SRCH);
			IOP->MMU->mapObject(0x1F900700, IOP->SPU2->CORES[1]->COMB2_R_SRCL);
			IOP->MMU->mapObject(0x1F900702, IOP->SPU2->CORES[1]->COMB2_R_SRCH);
			IOP->MMU->mapObject(0x1F900704, IOP->SPU2->CORES[1]->SAME_L_SRCL);
			IOP->MMU->mapObject(0x1F900706, IOP->SPU2->CORES[1]->SAME_L_SRCH);
			IOP->MMU->mapObject(0x1F900708, IOP->SPU2->CORES[1]->SAME_R_SRCL);
			IOP->MMU->mapObject(0x1F90070A, IOP->SPU2->CORES[1]->SAME_R_SRCH);
			IOP->MMU->mapObject(0x1F90070C, IOP->SPU2->CORES[1]->DIFF_L_DSTL);
			IOP->MMU->mapObject(0x1F90070E, IOP->SPU2->CORES[1]->DIFF_L_DSTH);
			IOP->MMU->mapObject(0x1F900710, IOP->SPU2->CORES[1]->DIFF_R_DSTL);
			IOP->MMU->mapObject(0x1F900712, IOP->SPU2->CORES[1]->DIFF_R_DSTH);
			IOP->MMU->mapObject(0x1F900714, IOP->SPU2->CORES[1]->COMB3_L_SRCL);
			IOP->MMU->mapObject(0x1F900716, IOP->SPU2->CORES[1]->COMB3_L_SRCH);
			IOP->MMU->mapObject(0x1F900718, IOP->SPU2->CORES[1]->COMB3_R_SRCL);
			IOP->MMU->mapObject(0x1F90071A, IOP->SPU2->CORES[1]->COMB3_R_SRCH);
			IOP->MMU->mapObject(0x1F90071C, IOP->SPU2->CORES[1]->COMB4_L_SRCL);
			IOP->MMU->mapObject(0x1F90071E, IOP->SPU2->CORES[1]->COMB4_L_SRCH);
			IOP->MMU->mapObject(0x1F900720, IOP->SPU2->CORES[1]->COMB4_R_SRCL);
			IOP->MMU->mapObject(0x1F900722, IOP->SPU2->CORES[1]->COMB4_R_SRCH);
			IOP->MMU->mapObject(0x1F900724, IOP->SPU2->CORES[1]->DIFF_L_SRCL);
			IOP->MMU->mapObject(0x1F900726, IOP->SPU2->CORES[1]->DIFF_L_SRCH);
			IOP->MMU->mapObject(0x1F900728, IOP->SPU2->CORES[1]->DIFF_R_SRCL);
			IOP->MMU->mapObject(0x1F90072A, IOP->SPU2->CORES[1]->DIFF_R_SRCH);
			IOP->MMU->mapObject(0x1F90072C, IOP->SPU2->CORES[1]->APF1_L_DSTL);
			IOP->MMU->mapObject(0x1F90072E, IOP->SPU2->CORES[1]->APF1_L_DSTH);
			IOP->MMU->mapObject(0x1F900730, IOP->SPU2->CORES[1]->APF1_R_DSTL);
			IOP->MMU->mapObject(0x1F900732, IOP->SPU2->CORES[1]->APF1_R_DSTH);
			IOP->MMU->mapObject(0x1F900734, IOP->SPU2->CORES[1]->APF2_L_DSTL);
			IOP->MMU->mapObject(0x1F900736, IOP->SPU2->CORES[1]->APF2_L_DSTH);
			IOP->MMU->mapObject(0x1F900738, IOP->SPU2->CORES[1]->APF2_R_DSTL);
			IOP->MMU->mapObject(0x1F90073A, IOP->SPU2->CORES[1]->APF2_R_DSTH);
			IOP->MMU->mapObject(0x1F90073C, IOP->SPU2->CORES[1]->EEAL);
			IOP->MMU->mapObject(0x1F90073E, IOP->SPU2->CORES[1]->EEAH);
