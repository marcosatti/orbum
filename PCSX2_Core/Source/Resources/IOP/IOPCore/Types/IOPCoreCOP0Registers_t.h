...
public:
	...
	IOPCoreCOP0Register_Context_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
};
...
public:
	...
	IOPCoreCOP0Register_Status_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
...
public:
	...
	IOPCoreCOP0Register_Cause_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
...
public:
	...
	IOPCoreCOP0Register_PRId_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
};