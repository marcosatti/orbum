...
Common_t::Common_t() :
	...
	FIFO_VIF0(std::make_shared<FIFOQueue32_t>("FIFO VIF0", false, true, DEBUG_FIFO_SIZE)),
	FIFO_VIF1(std::make_shared<FIFOQueue32_t>("FIFO VIF1", false, true, DEBUG_FIFO_SIZE)),
	FIFO_GIF(std::make_shared<FIFOQueue32_t>("FIFO GIF", false, true, DEBUG_FIFO_SIZE)),
	FIFO_fromIPU(std::make_shared<FIFOQueue32_t>("FIFO fromIPU", false, true, DEBUG_FIFO_SIZE)),
	FIFO_toIPU(std::make_shared<FIFOQueue32_t>("FIFO toIPU", false, true, DEBUG_FIFO_SIZE)),
	...
	FIFO_SIF2(std::make_shared<SBUSFIFOQueue_SIF2_t>("FIFO SIF2", false, true, DEBUG_FIFO_SIZE, SBUS_F300)),
	FIFO_fromMDEC(std::make_shared<FIFOQueue32_t>("FIFO fromMDEC", false, true, DEBUG_FIFO_SIZE)),
	FIFO_toMDEC(std::make_shared<FIFOQueue32_t>("FIFO toMDEC", false, true, DEBUG_FIFO_SIZE)),
	FIFO_CDROM(std::make_shared<FIFOQueue32_t>("FIFO CDROM", false, true, DEBUG_FIFO_SIZE)),
	FIFO_SPU2C0(std::make_shared<FIFOQueue32_t>("FIFO SPU2C0", false, false, DEBUG_FIFO_SIZE)),
	FIFO_PIO(std::make_shared<FIFOQueue32_t>("FIFO PIO", false, true, DEBUG_FIFO_SIZE)),
	FIFO_OTClear(std::make_shared<FIFOQueue32_t>("FIFO OTClear", false, true, DEBUG_FIFO_SIZE)),
	FIFO_SPU2C1(std::make_shared<FIFOQueue32_t>("FIFO SPU2C1", false, false, DEBUG_FIFO_SIZE)),
	FIFO_DEV9(std::make_shared<FIFOQueue32_t>("FIFO DEV9", false, true, DEBUG_FIFO_SIZE)),
	FIFO_fromSIO2(std::make_shared<FIFOQueue32_t>("FIFO fromSIO2", false, true, DEBUG_FIFO_SIZE)),
	FIFO_toSIO2(std::make_shared<FIFOQueue32_t>("FIFO toSIO2", false, true, DEBUG_FIFO_SIZE))
{
}
