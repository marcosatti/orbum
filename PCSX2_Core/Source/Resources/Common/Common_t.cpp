...
Common_t::Common_t() :
	...
	FIFO_SPU2C0(std::make_shared<FIFOQueue32_t>("FIFO SPU2C0", true, true, DEBUG_FIFO_SIZE)),
	...
	FIFO_SPU2C1(std::make_shared<FIFOQueue32_t>("FIFO SPU2C1", true, true, DEBUG_FIFO_SIZE)),
