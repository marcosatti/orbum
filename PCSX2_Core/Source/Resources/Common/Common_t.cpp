...
Common_t::Common_t() :
	...
	FIFO_VIF0(std::make_shared<FIFOQueue_t>("FIFO VIF0", false, false, DEBUG_FIFO_SIZE)),
	FIFO_VIF1(std::make_shared<FIFOQueue_t>("FIFO VIF1", false, false, DEBUG_FIFO_SIZE)),
	FIFO_GIF(std::make_shared<FIFOQueue_t>("FIFO GIF", false, false, DEBUG_FIFO_SIZE)),
	FIFO_fromIPU(std::make_shared<FIFOQueue_t>("FIFO fromIPU", false, false, DEBUG_FIFO_SIZE)),
	FIFO_toIPU(std::make_shared<FIFOQueue_t>("FIFO toIPU", false, false, DEBUG_FIFO_SIZE)),
	FIFO_SIF0(std::make_shared<FIFOQueue_t>("FIFO SIF0", false, false, DEBUG_FIFO_SIZE)),
	FIFO_SIF1(std::make_shared<FIFOQueue_t>("FIFO SIF1", false, false, DEBUG_FIFO_SIZE)),
