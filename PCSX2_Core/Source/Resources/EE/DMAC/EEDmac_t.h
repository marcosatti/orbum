...
public:
	...
	Initialised at runtime due to FIFO queue dependencies! See PS2Resources::initDMAChannelFifoQueues_EE().
	*/
	...
	std::shared_ptr<EEDmacChannel_t>         CHANNELS[Constants::EE::DMAC::NUMBER_DMAC_CHANNELS];
