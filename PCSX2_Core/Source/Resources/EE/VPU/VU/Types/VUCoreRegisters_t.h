...
public:
	...
	VUCoreRegister_Status_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
...
public:
	...
	VUCoreRegister_Clipping_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
...
public:
	...
	VUCoreRegister_CMSAR_t(const char * mnemonic, const bool debugReads, const bool debugWrites);
};
