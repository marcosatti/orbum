...
GS_t::GS_t() :
	...
	MEMORY_00F0(std::make_shared<ConstantByteMemory_t>(0x310, "SPE: SPE_00f0 (reserved)")),
	CSR(std::make_shared<Register64_t>("SPE: CSR")),
	IMR(std::make_shared<Register64_t>("SPE: IMR")),
	MEMORY_1020(std::make_shared<ConstantByteMemory_t>(0x20, "SPE: SPE_1020 (reserved)")),
	BUSDIR(std::make_shared<Register64_t>("SPE: BUSDIR")),
	MEMORY_1050(std::make_shared<ConstantByteMemory_t>(0x30, "SPE: SPE_1050 (reserved)")),
	SIGLBLID(std::make_shared<Register64_t>("SPE: SIGLBLID")),
	MEMORY_1090(std::make_shared<ConstantByteMemory_t>(0x60, "SPE: SPE_1090 (reserved)")),
	MEMORY_1100(std::make_shared<ConstantByteMemory_t>(0x300, "SPE: SPE_1100 (reserved)")),
	MEMORY_2000(std::make_shared<ConstantByteMemory_t>(0xE000, "SPE: SPE_2000 (reserved)"))
{
}
