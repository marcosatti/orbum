...
MIPSInstructionHelper_t::MIPSInstructionHelper_t(u32 instructionValue)
{
	this->mInstructionValue = instructionValue;
}

void MIPSInstructionHelper_t::setInstruction(const u32 instructionValue)
{
	mInstructionValue = instructionValue;
}

INLINE u8 MIPSInstructionHelper_t::getOpcode() const
{
...
INLINE u8 MIPSInstructionHelper_t::getRRs() const
{
	return (static_cast<u8>(mInstructionValue >> 21) & 0x1F);
}

INLINE u8 MIPSInstructionHelper_t::getRRt() const
{
	return (static_cast<u8>(mInstructionValue >> 16) & 0x1F);
}

INLINE u8 MIPSInstructionHelper_t::getRRd() const
{
	return (static_cast<u8>(mInstructionValue >> 11) & 0x1F);
}

INLINE u8 MIPSInstructionHelper_t::getRShamt() const
{
	return (static_cast<u8>(mInstructionValue >> 6) & 0x1F);
}

INLINE u8 MIPSInstructionHelper_t::getRFunct() const
{
...
INLINE s32 MIPSInstructionHelper_t::getJPAddress() const
{
...
INLINE u32 MIPSInstructionHelper_t::getJJumpAddress(Register32_t& PC) const
{
...
INLINE u8 MIPSInstructionHelper_t::getIRs() const
{
	return (static_cast<u8>(mInstructionValue >> 21) & 0x1F);
}

INLINE u8 MIPSInstructionHelper_t::getIRd() const
{
	return (static_cast<u8>(mInstructionValue >> 16) & 0x1F);
}

INLINE u16 MIPSInstructionHelper_t::getIImmU() const
{
	return static_cast<u16>(mInstructionValue & 0xFFFF);
}

INLINE s16 MIPSInstructionHelper_t::getIImmS() const
{
	return (static_cast<s16>(mInstructionValue) & 0xFFFF);
}

INLINE u8 MIPSInstructionHelper_t::getISignBit() const
{
	return (static_cast<u8>(mInstructionValue >> 15) & 0x1);
}

INLINE u32 MIPSInstructionHelper_t::getIBranchAddress(Register32_t& PC) const
{
	s32 IMM32 = static_cast<s32>(getIImmS());
	return static_cast<u32>((IMM32 << 2) + PC.UW);
}

INLINE u16 MIPSInstructionHelper_t::getITrapCode() const
{
