...
*/
class MapperRegister128ByteMMU_t : public MapperBaseObjectByteMMU_t
{
public:
	explicit MapperRegister128ByteMMU_t(const u32 physicalAddress, const std::shared_ptr<Register128_t> & register128);
...
private:
	...
	*/
	std::shared_ptr<Register128_t> mRegister128;
};