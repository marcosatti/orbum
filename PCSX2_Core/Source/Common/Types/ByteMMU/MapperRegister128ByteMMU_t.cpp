...
const char* MapperRegister128ByteMMU_t::getMnemonic() const
{
	return mRegister128->getMnemonic();
}

u8 MapperRegister128ByteMMU_t::readByte(const System_t context, size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MapperRegister128ByteMMU_t::writeByte(const System_t context, size_t storageIndex, u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MapperRegister128ByteMMU_t with unaligned index. Not allowed.");
...
u16 MapperRegister128ByteMMU_t::readHword(const System_t context, size_t storageIndex)
{
...
void MapperRegister128ByteMMU_t::writeHword(const System_t context, size_t storageIndex, u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MapperRegister128ByteMMU_t with unaligned index. Not allowed.");
...
u32 MapperRegister128ByteMMU_t::readWord(const System_t context, size_t storageIndex)
{
...
void MapperRegister128ByteMMU_t::writeWord(const System_t context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MapperRegister128ByteMMU_t with unaligned index. Not allowed.");
...
u64 MapperRegister128ByteMMU_t::readDword(const System_t context, size_t storageIndex)
{
...
void MapperRegister128ByteMMU_t::writeDword(const System_t context, size_t storageIndex, u64 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MapperRegister128ByteMMU_t with unaligned index. Not allowed.");
...
u128 MapperRegister128ByteMMU_t::readQword(const System_t context, size_t storageIndex)
{
...
void MapperRegister128ByteMMU_t::writeQword(const System_t context, size_t storageIndex, u128 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_QWORD != 0)
		throw std::runtime_error("Tried to access MapperRegister128ByteMMU_t with unaligned index. Not allowed.");
