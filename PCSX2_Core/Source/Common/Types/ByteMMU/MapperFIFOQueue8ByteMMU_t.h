...
*/
class MapperFIFOQueue8ByteMMU_t : public MapperBaseObjectByteMMU_t
{
public:
	MapperFIFOQueue8ByteMMU_t(const u32 physicalAddress, const std::shared_ptr<FIFOQueue8_t> & fifoQueue8);
...
private:
	...
	*/
	std::shared_ptr<FIFOQueue8_t> mFIFOQueue8;
};