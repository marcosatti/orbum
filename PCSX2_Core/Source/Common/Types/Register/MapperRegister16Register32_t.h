...
{
public:
	explicit MapperRegister16Register32_t(const std::shared_ptr<Register16_t> & register16);
	explicit MapperRegister16Register32_t(const char * mnemonic, const std::shared_ptr<Register16_t> & register16);
