...
void ConstantRegister32_t::writeByte(const Context_t context, size_t arrayIndex, u8 value)
{
	// Do not write value (zero register).
}

void ConstantRegister32_t::writeHword(const Context_t context, size_t arrayIndex, u16 value)
{
	// Do not write value (zero register).
}
