...
void ConstantRegister16_t::writeByte(const Context& context, size_t arrayIndex, u8 value)
{
	// Do not write value (zero register).
}

void ConstantRegister16_t::writeHword(const Context& context, u16 value)
{
	// Do not write value (zero register).
}
