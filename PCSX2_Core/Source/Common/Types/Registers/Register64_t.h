...
public:
	...
	*/
	virtual u8 readByte(const Context & context, size_t arrayIndex);
	virtual void writeByte(const Context & context, size_t arrayIndex, u8 value);
	virtual u16 readHword(const Context & context, size_t arrayIndex);
	virtual void writeHword(const Context & context, size_t arrayIndex, u16 value);
	...
	virtual u64 readDword(const Context & context);
	virtual void writeDword(const Context & context, u64 value);
