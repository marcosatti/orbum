...
u8 WrapperR16Register32_t::readByte(const Context_t& context, u32 arrayIndex)
{
	throw std::runtime_error("Only Word R/W wrapper calls to Register16_t are allowed.");
}

void WrapperR16Register32_t::writeByte(const Context_t& context, u32 arrayIndex, u8 value)
{
	throw std::runtime_error("Only Word R/W wrapper calls to Register16_t are allowed.");
}

u16 WrapperR16Register32_t::readHword(const Context_t& context, u32 arrayIndex)
{
	throw std::runtime_error("Only Word R/W wrapper calls to Register16_t are allowed.");
}

void WrapperR16Register32_t::writeHword(const Context_t& context, u32 arrayIndex, u16 value)
{
	throw std::runtime_error("Only Word R/W wrapper calls to Register16_t are allowed.");
}
