...
u8 Register16_t::readByte(const Context& context, size_t arrayIndex)
{
#if defined(BUILD_DEBUG)
	if (mDebugReads)
	{
...
void Register16_t::writeByte(const Context& context, size_t arrayIndex, u8 value)
{
	UB[arrayIndex] = value;
...
u16 Register16_t::readHword(const Context& context)
{
#if defined(BUILD_DEBUG)
	if (mDebugReads)
	{
...
void Register16_t::writeHword(const Context& context, u16 value)
{
	UH = value;
