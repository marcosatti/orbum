...
{
	throw std::runtime_error("Tried to access MappedFPRegister128_t with non-allowed call");
}
...
u32 MappedFPRegister128_t::readWordU(u32 storageIndex)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned word index. Not allowed.");
	return mFPRegister128->readWordU(storageIndex / Constants::NUMBER_BYTES_IN_WORD);
}
...
void MappedFPRegister128_t::writeWordU(u32 storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned word index. Not allowed.");
	mFPRegister128->writeWordU(storageIndex / Constants::NUMBER_BYTES_IN_WORD, value);
}
...
s32 MappedFPRegister128_t::readWordS(u32 storageIndex)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned word index. Not allowed.");
	return mFPRegister128->readWordS(storageIndex / Constants::NUMBER_BYTES_IN_WORD);
}
...
void MappedFPRegister128_t::writeWordS(u32 storageIndex, s32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned word index. Not allowed.");
	mFPRegister128->writeWordS(storageIndex / Constants::NUMBER_BYTES_IN_WORD, value);
}

u64 MappedFPRegister128_t::readDwordU(u32 storageIndex)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned dword index. Not allowed.");
