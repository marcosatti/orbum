...
u8 MappedFPRegister128_t::readByte(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister128_t with smaller than allowed size. Not allowed.");
}

void MappedFPRegister128_t::writeByte(const Context& context, size_t storageIndex, u8 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister128_t with smaller than allowed size. Not allowed.");
}

u16 MappedFPRegister128_t::readHword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister128_t with smaller than allowed size. Not allowed.");
}

void MappedFPRegister128_t::writeHword(const Context& context, size_t storageIndex, u16 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister128_t with smaller than allowed size. Not allowed.");
}

u32 MappedFPRegister128_t::readWord(const Context& context, size_t storageIndex)
{
...
void MappedFPRegister128_t::writeWord(const Context& context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned index. Not allowed.");
...
u64 MappedFPRegister128_t::readDword(const Context& context, size_t storageIndex)
{
...
void MappedFPRegister128_t::writeDword(const Context& context, size_t storageIndex, u64 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned index. Not allowed.");
...
u128 MappedFPRegister128_t::readQword(const Context& context, size_t storageIndex)
{
...
void MappedFPRegister128_t::writeQword(const Context& context, size_t storageIndex, u128 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_QWORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned index. Not allowed.");
