...
{
	if (storageIndex != 0)
		throw std::runtime_error("Tried to access MappedRegister8_t unaligned (storageIndex != 0). Not allowed.");
...
{
	throw std::runtime_error("Tried to access MappedRegister8_t with a size other than Byte. Not allowed.");
}
