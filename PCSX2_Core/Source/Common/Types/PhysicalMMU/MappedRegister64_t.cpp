...
u8 MappedRegister64_t::readByte(const Context& context, size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MappedRegister64_t::writeByte(const Context& context, size_t storageIndex, u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MappedRegister64_t with unaligned index. Not allowed.");
...
u16 MappedRegister64_t::readHword(const Context& context, size_t storageIndex)
{
...
void MappedRegister64_t::writeHword(const Context& context, size_t storageIndex, u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister64_t with unaligned index. Not allowed.");
...
u32 MappedRegister64_t::readWord(const Context& context, size_t storageIndex)
{
...
void MappedRegister64_t::writeWord(const Context& context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedRegister64_t with unaligned index. Not allowed.");
...
u64 MappedRegister64_t::readDword(const Context& context, size_t storageIndex)
{
...
void MappedRegister64_t::writeDword(const Context& context, size_t storageIndex, u64 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister64_t with unaligned index. Not allowed.");
...
u128 MappedRegister64_t::readQword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister64_t with larger than allowed size. Not allowed.");
}

void MappedRegister64_t::writeQword(const Context& context, size_t storageIndex, u128 value)
{
	throw std::runtime_error("Tried to access MappedRegister64_t with larger than allowed size. Not allowed.");
}
