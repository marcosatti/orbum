...
u8 MappedFPRegister32_t::readByte(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with smaller than allowed size. Not allowed.");
}

void MappedFPRegister32_t::writeByte(const Context& context, size_t storageIndex, u8 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with smaller than allowed size. Not allowed.");
}

u16 MappedFPRegister32_t::readHword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with smaller than allowed size. Not allowed.");
}

void MappedFPRegister32_t::writeHword(const Context& context, size_t storageIndex, u16 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with smaller than allowed size. Not allowed.");
}

u32 MappedFPRegister32_t::readWord(const Context& context, size_t storageIndex)
{
...
void MappedFPRegister32_t::writeWord(const Context& context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister32_t with unaligned index. Not allowed.");
...
u64 MappedFPRegister32_t::readDword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with larger than allowed size. Not allowed.");
}

void MappedFPRegister32_t::writeDword(const Context& context, size_t storageIndex, u64 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with larger than allowed size. Not allowed.");
}

u128 MappedFPRegister32_t::readQword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with larger than allowed size. Not allowed.");
}

void MappedFPRegister32_t::writeQword(const Context& context, size_t storageIndex, u128 value)
{
	throw std::runtime_error("Tried to access MappedFPRegister32_t with larger than allowed size. Not allowed.");
}
