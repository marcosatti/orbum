...
u8 MappedRegister32_t::readByte(const Context_t context, size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MappedRegister32_t::writeByte(const Context_t context, size_t storageIndex, u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MappedRegister32_t with unaligned index. Not allowed.");
...
u16 MappedRegister32_t::readHword(const Context_t context, size_t storageIndex)
{
...
void MappedRegister32_t::writeHword(const Context_t context, size_t storageIndex, u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister32_t with unaligned index. Not allowed.");
...
u32 MappedRegister32_t::readWord(const Context_t context, size_t storageIndex)
{
...
void MappedRegister32_t::writeWord(const Context_t context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedRegister32_t with unaligned index. Not allowed.");
...
u64 MappedRegister32_t::readDword(const Context_t context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister32_t with larger than allowed size. Not allowed.");
}

void MappedRegister32_t::writeDword(const Context_t context, size_t storageIndex, u64 value)
{
	throw std::runtime_error("Tried to access MappedRegister32_t with larger than allowed size. Not allowed.");
}

u128 MappedRegister32_t::readQword(const Context_t context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister32_t with larger than allowed size. Not allowed.");
}

void MappedRegister32_t::writeQword(const Context_t context, size_t storageIndex, u128 value)
{
	throw std::runtime_error("Tried to access MappedRegister32_t with larger than allowed size. Not allowed.");
}
