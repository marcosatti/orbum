...
The storageIndex param must be equal to 0 (or 8 for Dword access, for getting a full 128-bit value), otherwise a runtime_error is thrown (alignment conditions).
