...
u8 MappedFIFOQueue32_t::readByte(const Context_t context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

void MappedFIFOQueue32_t::writeByte(const Context_t context, size_t storageIndex, u8 value)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

u16 MappedFIFOQueue32_t::readHword(const Context_t context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

void MappedFIFOQueue32_t::writeHword(const Context_t context, size_t storageIndex, u16 value)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

u32 MappedFIFOQueue32_t::readWord(const Context_t context, size_t storageIndex)
{
	if (storageIndex != 0)
...
void MappedFIFOQueue32_t::writeWord(const Context_t context, size_t storageIndex, u32 value)
{
	if (storageIndex != 0)
		throw std::runtime_error("Tried to access MappedFIFOQueue_t with non-zero index. Not allowed.");
...
u64 MappedFIFOQueue32_t::readDword(const Context_t context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

void MappedFIFOQueue32_t::writeDword(const Context_t context, size_t storageIndex, u64 value)
{
	throw std::runtime_error("Tried to access MappedFIFOQueue_t with invalid function. Not allowed.");
}

u128 MappedFIFOQueue32_t::readQword(const Context_t context, size_t storageIndex)
{
	if (storageIndex != 0)
		throw std::runtime_error("Tried to access MappedFIFOQueue_t with non-zero index. Not allowed.");
...
void MappedFIFOQueue32_t::writeQword(const Context_t context, size_t storageIndex, u128 value)
{
	if (storageIndex != 0)
		throw std::runtime_error("Tried to access MappedFIFOQueue_t with non-zero index. Not allowed.");
