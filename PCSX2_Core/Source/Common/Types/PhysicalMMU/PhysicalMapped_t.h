...
public:
	...
	*/
	virtual u8 readByte(const Context & context, size_t storageIndex) = 0;
	virtual void writeByte(const Context & context, size_t storageIndex, u8 value) = 0;
	virtual u16 readHword(const Context & context, size_t storageIndex) = 0;
	virtual void writeHword(const Context & context, size_t storageIndex, u16 value) = 0;
	virtual u32 readWord(const Context & context, size_t storageIndex) = 0;
	virtual void writeWord(const Context & context, size_t storageIndex, u32 value) = 0;
	virtual u64 readDword(const Context & context, size_t storageIndex) = 0;
	virtual void writeDword(const Context & context, size_t storageIndex, u64 value) = 0;
	virtual u128 readQword(const Context & context, size_t storageIndex) = 0;
	virtual void writeQword(const Context & context, size_t storageIndex, u128 value) = 0;
