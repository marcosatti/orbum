...
u8 MappedRegister128_t::readByte(const System_t context, size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MappedRegister128_t::writeByte(const System_t context, size_t storageIndex, u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MappedRegister128_t with unaligned index. Not allowed.");
...
u16 MappedRegister128_t::readHword(const System_t context, size_t storageIndex)
{
...
void MappedRegister128_t::writeHword(const System_t context, size_t storageIndex, u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister128_t with unaligned index. Not allowed.");
...
u32 MappedRegister128_t::readWord(const System_t context, size_t storageIndex)
{
...
void MappedRegister128_t::writeWord(const System_t context, size_t storageIndex, u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MappedRegister128_t with unaligned index. Not allowed.");
...
u64 MappedRegister128_t::readDword(const System_t context, size_t storageIndex)
{
...
void MappedRegister128_t::writeDword(const System_t context, size_t storageIndex, u64 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister128_t with unaligned index. Not allowed.");
...
u128 MappedRegister128_t::readQword(const System_t context, size_t storageIndex)
{
...
void MappedRegister128_t::writeQword(const System_t context, size_t storageIndex, u128 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_QWORD != 0)
		throw std::runtime_error("Tried to access MappedFPRegister128_t with unaligned index. Not allowed.");
