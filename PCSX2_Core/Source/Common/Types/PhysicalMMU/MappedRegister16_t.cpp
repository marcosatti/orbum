...
u8 MappedRegister16_t::readByte(const Context& context, size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MappedRegister16_t::writeByte(const Context& context, size_t storageIndex, u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MappedRegister16_t with unaligned index. Not allowed.");
...
u16 MappedRegister16_t::readHword(const Context& context, size_t storageIndex)
{
...
void MappedRegister16_t::writeHword(const Context& context, size_t storageIndex, u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MappedRegister16_t with unaligned index. Not allowed.");
...
u32 MappedRegister16_t::readWord(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}

void MappedRegister16_t::writeWord(const Context& context, size_t storageIndex, u32 value)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}

u64 MappedRegister16_t::readDword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}

void MappedRegister16_t::writeDword(const Context& context, size_t storageIndex, u64 value)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}

u128 MappedRegister16_t::readQword(const Context& context, size_t storageIndex)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}

void MappedRegister16_t::writeQword(const Context& context, size_t storageIndex, u128 value)
{
	throw std::runtime_error("Tried to access MappedRegister16_t with larger than allowed size. Not allowed.");
}
