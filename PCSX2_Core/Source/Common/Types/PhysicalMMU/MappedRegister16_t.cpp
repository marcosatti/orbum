...
{
	throw std::runtime_error("Tried to access MappedRegister16_t with a size other than Hword. Not allowed.");
}
...
{
	if (storageIndex != 0)
		throw std::runtime_error("Tried to access MappedRegister16_t unaligned (storageIndex != 0). Not allowed.");
