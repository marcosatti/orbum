...
public:
	...
	*/
	...
	const std::shared_ptr<BitfieldRegister32_t> Registers[PS2Constants::EE::EECore::COP0::NUMBER_REGISTERS] = {
		Index, Random, EntryLo0, EntryLo1, Context, PageMask, Wired, reserved0, BadVAddr, Count, EntryHi, Compare, Status, Cause, EPC, PRId, 
		Config, reserved1, reserved2, reserved3, reserved4, reserved5, reserved6, BadPAddr, BPC, PCCR, reserved7, reserved8, TagLo, TagHi, 
		ErrorEPC, reserved9
	};
	// Array of PCR0/PCR1, used by the MFPC/MTPC instructions.
	const std::shared_ptr<BitfieldRegister32_t> PCRRegisters[PS2Constants::EE::EECore::COP0::NUMBER_PCR_REGISTERS] = {
		PCR0, PCR1
	};
