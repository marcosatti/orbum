...
class DebugMMemory_t : public MappedMemory_t
{
public:
	DebugMMemory_t(const size_t & size, const char *const mnemonic, const u32 & PS2PhysicalAddress);
	virtual ~DebugMMemory_t();
