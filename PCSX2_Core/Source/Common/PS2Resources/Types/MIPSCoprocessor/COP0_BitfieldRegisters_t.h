...
*/
class COP0RegisterCompare_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit COP0RegisterCompare_t(std::shared_ptr<COP0RegisterCause_t> Cause);

	void setFieldValue(const u8 & fieldIndex, const u32& value) override;
	void setRegisterValue(const u32 & value) override;

private:
	std::shared_ptr<COP0RegisterCause_t> mCause;
};
...
*/
class COP0RegisterPRId_EECore_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit COP0RegisterPRId_EECore_t();
};
...
(Same structure.)
*/
class COP0RegisterPRId_IOP_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit COP0RegisterPRId_IOP_t();
};
