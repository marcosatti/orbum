...
public:
	...
	*/
	...
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T0_COMP;
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T0_HOLD;
	std::shared_ptr<DeadMMemory_t>         TIMERS_MEMORY_TIMER_0040;
	std::shared_ptr<TimersRegisterCount_t> TIMERS_REGISTER_T1_COUNT;
	std::shared_ptr<TimersRegisterMode_t>  TIMERS_REGISTER_T1_MODE;
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T1_COMP;
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T1_HOLD;
	std::shared_ptr<DeadMMemory_t>         TIMERS_MEMORY_TIMER_0840;
	std::shared_ptr<TimersRegisterCount_t> TIMERS_REGISTER_T2_COUNT;
	std::shared_ptr<TimersRegisterMode_t>  TIMERS_REGISTER_T2_MODE;
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T2_COMP;
	std::shared_ptr<DeadMMemory_t>         TIMERS_MEMORY_TIMER_1030;
	std::shared_ptr<TimersRegisterCount_t> TIMERS_REGISTER_T3_COUNT;
	std::shared_ptr<TimersRegisterMode_t>  TIMERS_REGISTER_T3_MODE;
	std::shared_ptr<Register32_t>          TIMERS_REGISTER_T3_COMP;
	std::shared_ptr<DeadMMemory_t>         TIMERS_MEMORY_TIMER_1830;
