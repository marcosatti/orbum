...
class EERegisterINTCIMask_t;

class EERegisterTimerMode_t;
class EERegisterTimerCount_t;

class EERegisterDMACDChcr_t;
class EERegisterDMACDMadr_t;
class EERegisterDMACDTadr_t;
class EERegisterDMACDAsr_t;
class EERegisterDMACDSadr_t;
class EERegisterDMACDQwc_t;
class EERegisterDMACDCtrl_t;
class EERegisterDMACDStat_t;
class EERegisterDMACDPcr_t;
class EERegisterDMACDSqwc_t;
class EERegisterDMACDRbor_t;
class EERegisterDMACDRbsr_t;
class EERegisterDMACDStadr_t;
class EERegisterDMACDEnablew_t;
class EERegisterDMACDEnabler_t;
...
public:
	...
	*/
	...
	// 0x10008000
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D0_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D0_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D0_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D0_TADR;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D0_ASR0;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D0_ASR1;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_8060;

	// 0x10009000
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D1_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D1_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D1_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D1_TADR;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D1_ASR0;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D1_ASR1;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_9060;

	// 0x1000A000
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D2_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D2_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D2_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D2_TADR;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D2_ASR0;
	std::shared_ptr<EERegisterDMACDAsr_t>     EE_REGISTER_D2_ASR1;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_a060;
	
	// 0x1000B000 
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D3_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D3_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D3_QWC;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_b030;
	
	// 0x1000B400
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D4_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D4_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D4_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D4_TADR;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_b440;

	// 0x1000C000
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D5_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D5_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D5_QWC;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_c030;

	// 0x1000C400
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D6_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D6_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D6_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D6_TADR;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_c440;
	
	// 0x1000C800
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D7_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D7_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D7_QWC;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_c830;

	// 0x1000D000
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D8_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D8_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D8_QWC;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_d030;
	std::shared_ptr<EERegisterDMACDSadr_t>    EE_REGISTER_D8_SADR;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_d090;

	// 0x1000D400
	std::shared_ptr<EERegisterDMACDChcr_t>    EE_REGISTER_D9_CHCR;
	std::shared_ptr<EERegisterDMACDMadr_t>    EE_REGISTER_D9_MADR;
	std::shared_ptr<EERegisterDMACDQwc_t>     EE_REGISTER_D9_QWC;
	std::shared_ptr<EERegisterDMACDTadr_t>    EE_REGISTER_D9_TADR;
	...
	struct DMACChannelRegisters_t
	{
		...
		std::shared_ptr<EERegisterDMACDMadr_t> MADR;
		std::shared_ptr<EERegisterDMACDQwc_t>  QWC;
		std::shared_ptr<EERegisterDMACDTadr_t> TADR;
	...
	std::shared_ptr<EERegisterDMACDStat_t>    EE_REGISTER_D_STAT;
	std::shared_ptr<EERegisterDMACDPcr_t>     EE_REGISTER_D_PCR;
	std::shared_ptr<EERegisterDMACDSqwc_t>    EE_REGISTER_D_SQWC;
	std::shared_ptr<EERegisterDMACDRbsr_t>    EE_REGISTER_D_RBSR;
	std::shared_ptr<EERegisterDMACDRbor_t>    EE_REGISTER_D_RBOR;
	std::shared_ptr<EERegisterDMACDStadr_t>   EE_REGISTER_D_STADR;
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_DMAC_e070;

	// 0x1000F000
	std::shared_ptr<EERegisterINTCIStat_t>    EE_REGISTER_I_STAT;
	std::shared_ptr<EERegisterINTCIMask_t>    EE_REGISTER_I_MASK;
	...
	std::shared_ptr<EERegisterDMACDEnabler_t> EE_REGISTER_D_ENABLER; 
	std::shared_ptr<DeadStorageObject_t>      EE_REGISTER_F530;      
	std::shared_ptr<EERegisterDMACDEnablew_t> EE_REGISTER_D_ENABLEW; 
