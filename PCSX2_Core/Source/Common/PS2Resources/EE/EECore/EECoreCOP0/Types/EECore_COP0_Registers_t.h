...
- Bits 31 (length 1): "P".
*/
class EECore_COP0RegisterIndex_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterIndex_t();
};
...
*/
class EECore_COP0RegisterRandom_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterRandom_t();
};
...
- Bits 31 (length 1): "S"
*/
class EECore_COP0RegisterEntryLo0_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterEntryLo0_t();
};
...
*/
class EECore_COP0RegisterEntryLo1_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterEntryLo1_t();
};
...
*/
class EECore_COP0RegisterContext_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterContext_t();
};
...
*/
class EECore_COP0RegisterPageMask_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterPageMask_t();
};
...
- Bits 6-31 (length 26): Constant 0.
*/
class EECore_COP0RegisterWired_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterWired_t();
};
...
*/
class EECore_COP0RegisterBadVAddr_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterBadVAddr_t();
};
...
*/
class EECore_COP0RegisterCount_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterCount_t();
...
*/
class EECore_COP0RegisterEntryHi_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterEntryHi_t();
};
...
- Bits 31 (length 1): "BD".
*/
class EECore_COP0RegisterCause_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterCause_t();
};
...
*/
class EECore_COP0RegisterCompare_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterCompare_t(std::shared_ptr<EECore_COP0RegisterCause_t> Cause);

	void setFieldValue(const u8 & fieldIndex, const u32& value) override;
	void setRegisterValue(const u32 & value) override;

private:
	std::shared_ptr<EECore_COP0RegisterCause_t> mCause;
};
...
*/
class EECore_COP0RegisterStatus_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterStatus_t();
};
...
*/
class EECore_COP0RegisterPRId_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterPRId_t();
};
...
*/
class EECore_COP0RegisterConfig_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterConfig_t();
};
...
*/
class EECore_COP0RegisterBadPAddr_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterBadPAddr_t();
};
...
*/
class EECore_COP0RegisterBPC_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterBPC_t();
};
...
*/
class EECore_COP0RegisterIAB_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterIAB_t();
};
...
*/
class EECore_COP0RegisterIABM_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterIABM_t();
};
...
*/
class EECore_COP0RegisterDAB_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterDAB_t();
};
...
*/
class EECore_COP0RegisterDABM_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterDABM_t();
};
...
*/
class EECore_COP0RegisterDVB_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterDVB_t();
};
...
*/
class EECore_COP0RegisterDVBM_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterDVBM_t();
};
...
*/
class EECore_COP0RegisterPCCR_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterPCCR_t();
};
...
*/
class EECore_COP0RegisterPCR0_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterPCR0_t();
};
...
- Bits 31 (length 1): "OVFL".
*/
class EECore_COP0RegisterPCR1_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterPCR1_t();
};
...
*/
class EECore_COP0RegisterTagLo_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterTagLo_t();
};
...
TODO: Verify this is correct, the manual doesn't explain this well...
*/
class EECore_COP0RegisterTagHi_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterTagHi_t();
};
...
*/
class EECore_COP0RegisterErrorEPC_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit EECore_COP0RegisterErrorEPC_t();
};