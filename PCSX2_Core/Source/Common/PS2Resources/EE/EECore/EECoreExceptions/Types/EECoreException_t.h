...
NOTE: Do NOT change the order - they are sync'd with the EECoreExceptionsTable::ExceptionProperties[] array. If you change one you must reflect the changes in the other.
*/
