...
IOPCore_t::IOPCore_t(const PS2Resources_t* const PS2Resources) :
	...
	ScratchpadMemory(std::make_shared<DebugMMemory_t>(PS2Constants::IOP::IOPCore::ScratchpadMemory::SIZE_SCRATCHPAD_MEMORY, "IOP Scratchpad Mem", PS2Constants::IOP::IOPCore::ScratchpadMemory::PADDRESS_SCRATCHPAD_MEMORY))
{
}
