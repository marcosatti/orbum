...
class IOPCore_COP0RegisterContext_t;
class IOPCore_COP0RegisterStatus_t;
class IOPCore_COP0RegisterCause_t;
class COP0RegisterEPC_t;
class IOPCore_COP0RegisterPRId_t;
...
public:
	...
	*/
	...
	std::shared_ptr<IOPCore_COP0RegisterContext_t> Context; // r4: Context.
	...
	std::shared_ptr<IOPCore_COP0RegisterStatus_t> Status;   // r12: Status.
	std::shared_ptr<IOPCore_COP0RegisterCause_t> Cause;     // r13: Cause.
	std::shared_ptr<COP0RegisterEPC_t> EPC;                 // r14: EPC.
	std::shared_ptr<IOPCore_COP0RegisterPRId_t> PRId;       // r15: PRId.
