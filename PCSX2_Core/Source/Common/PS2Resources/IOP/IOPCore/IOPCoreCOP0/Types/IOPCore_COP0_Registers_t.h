...
*/
class IOPCore_COP0RegisterContext_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit IOPCore_COP0RegisterContext_t();
};
...
TODO: Finish documentation.
*/
class IOPCore_COP0RegisterStatus_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit IOPCore_COP0RegisterStatus_t();
};
...
TODO: Finish documentation.
*/
class IOPCore_COP0RegisterCause_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit IOPCore_COP0RegisterCause_t();
};
...
TODO: Finish documentation.
*/
class IOPCore_COP0RegisterPRId_t : public BitfieldRegister32_t
{
public:
	struct Fields
	{
	...
	explicit IOPCore_COP0RegisterPRId_t();
};