...
void VUInterpreter::CLIP()
{
	...
	logDebug("(%s, %d) CLIP: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::RINIT()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) RINIT: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::RGET()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) RGET: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::RNEXT()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) RNEXT: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::RXOR()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) RXOR: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::WAITQ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) WAITQ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBEQ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBEQ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBGEZ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBGEZ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBGTZ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBGTZ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBLEZ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBLEZ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBLTZ()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBLTZ: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::IBNE()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) IBNE: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::B()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) B: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::BAL()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) BAL: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::JR()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) JR: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::JALR()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) JALR: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::WAITP()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) WAITP: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::XGKICK()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) XGKICK: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::XTOP()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) XTOP: Not implemented.", __FILENAME__, __LINE__);
#else
...
void VUInterpreter::XITOP()
{
	// TODO: Implement.
#if defined(BUILD_DEBUG)
	logDebug("(%s, %d) XITOP: Not implemented.", __FILENAME__, __LINE__);
#else
