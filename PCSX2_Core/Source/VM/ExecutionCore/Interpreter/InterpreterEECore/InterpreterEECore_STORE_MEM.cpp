...
{
	// MEM[UB] = Rd. Exceptions generated through other components.
...
{
	// MEM[UH] = Rd. Exceptions generated through other components.
	auto& source1Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRs()]; // "Base"
	auto& source2Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRt()];
	const s16 imm = getInstruction().getIImmS();
...
{
	// MEM[UW] = Rd. Exceptions generated through other components.
	auto& source1Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRs()]; // "Base"
	auto& source2Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRt()];
	const s16 imm = getInstruction().getIImmS();
...
{
	// MEM[UQ] = Rd. Exceptions generated through other components.
	auto& source1Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRs()]; // "Base"
	auto& source2Reg = getVM()->getResources()->EE->EECore->R5900->GPR[getInstruction().getIRt()];
	const s16 imm = getInstruction().getIImmS();
...
{
	// MEM[UQ] = Ft. Exceptions generated through other components.
