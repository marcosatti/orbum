...
{
public:
	Register64_t(const char * mnemonic, bool debugReads, bool debugWrites, const u64 initialisationValue = 0);
	...
	*/
	...
	virtual void writeDword(const Context_t context, const u64 value);
