...
void ConstantRegister16_t::writeByte(const Context_t context, const size_t arrayIndex, const u8 value)
{
	// Do not write value (zero register).
}

void ConstantRegister16_t::writeHword(const Context_t context, const u16 value)
{
	// Do not write value (zero register).
}
