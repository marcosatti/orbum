...
const std::shared_ptr<MapperBaseObjectByteMMU_t>& ByteMMU_t::getMappedObject(const Context_t context, const VAddressProperties_t& properties)
{
	...
	if (object == nullptr)
	{
		...
		stringStream << DEBUG_CONTEXT_STRINGS[context] << ": ByteMMU lookup failed (nullptr). Address (inc. offset) = 0x" << std::uppercase << std::setfill('0') << std::setw(8) << std::hex << address << ".";
...
u8 ByteMMU_t::readByte(const Context_t context, const u32 physicalAddress)
{
...
void ByteMMU_t::writeByte(const Context_t context, const u32 physicalAddress, const u8 value)
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
u16 ByteMMU_t::readHword(const Context_t context, const u32 physicalAddress) 
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
void ByteMMU_t::writeHword(const Context_t context, const u32 physicalAddress, const u16 value) 
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
u32 ByteMMU_t::readWord(const Context_t context, const u32 physicalAddress) 
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
void ByteMMU_t::writeWord(const Context_t context, const u32 physicalAddress, const u32 value) 
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
u64 ByteMMU_t::readDword(const Context_t context, const u32 physicalAddress)
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
void ByteMMU_t::writeDword(const Context_t context, const u32 physicalAddress, const u64 value)
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
u128 ByteMMU_t::readQword(const Context_t context, const u32 physicalAddress) 
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
...
void ByteMMU_t::writeQword(const Context_t context, const u32 physicalAddress, const u128 value)
{
	// Get the virtual address properties, including VDN, VPN and offset.
	auto properties = getVAddressProperties(physicalAddress);
