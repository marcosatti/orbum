...
u8 MapperRegister64ByteMMU_t::readByte(const Context_t context, const size_t storageIndex)
{
	if (storageIndex % 1 != 0)
...
void MapperRegister64ByteMMU_t::writeByte(const Context_t context, const size_t storageIndex, const u8 value)
{
	if (storageIndex % 1 != 0)
		throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with unaligned index. Not allowed.");
...
u16 MapperRegister64ByteMMU_t::readHword(const Context_t context, const size_t storageIndex)
{
...
void MapperRegister64ByteMMU_t::writeHword(const Context_t context, const size_t storageIndex, const u16 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_HWORD != 0)
		throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with unaligned index. Not allowed.");
...
u32 MapperRegister64ByteMMU_t::readWord(const Context_t context, const size_t storageIndex)
{
...
void MapperRegister64ByteMMU_t::writeWord(const Context_t context, const size_t storageIndex, const u32 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_WORD != 0)
		throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with unaligned index. Not allowed.");
...
u64 MapperRegister64ByteMMU_t::readDword(const Context_t context, const size_t storageIndex)
{
...
void MapperRegister64ByteMMU_t::writeDword(const Context_t context, const size_t storageIndex, const u64 value)
{
	if (storageIndex % Constants::NUMBER_BYTES_IN_DWORD != 0)
		throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with unaligned index. Not allowed.");
...
u128 MapperRegister64ByteMMU_t::readQword(const Context_t context, const size_t storageIndex)
{
	throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with larger than allowed size. Not allowed.");
}

void MapperRegister64ByteMMU_t::writeQword(const Context_t context, const size_t storageIndex, const u128 value)
{
	throw std::runtime_error("Tried to access MapperRegister64ByteMMU_t with larger than allowed size. Not allowed.");
}
