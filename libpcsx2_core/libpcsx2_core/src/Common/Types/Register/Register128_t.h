...
{
public:
	Register128_t(const char * mnemonic, bool debugReads, bool debugWrites, const u128 initialisationValue = 0); 
	...
	*/
	...
	virtual u16 readHword(const Context_t context, const size_t arrayIndex);
	virtual void writeHword(const Context_t context, const size_t arrayIndex, const u16 value);
	virtual u32 readWord(const Context_t context, const size_t arrayIndex);
	virtual void writeWord(const Context_t context, const size_t arrayIndex, const u32 value);
	virtual u64 readDword(const Context_t context, const size_t arrayIndex);
	virtual void writeDword(const Context_t context, const size_t arrayIndex, const u64 value);
	virtual u128 readQword(const Context_t context);
	virtual void writeQword(const Context_t context, const u128 value);
	virtual f32 readFloat(const Context_t context, const size_t arrayIndex);
	virtual void writeFloat(const Context_t context, const size_t arrayIndex, const f32 value);
