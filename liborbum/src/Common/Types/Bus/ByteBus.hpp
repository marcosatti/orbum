...
template<typename AddressTy>
ByteBus<AddressTy>::ByteBus(const int directory_mask_length) :
...
template<typename AddressTy>
void ByteBus<AddressTy>::map(const AddressTy address, ByteBusMappable * object)
{
...
template<typename AddressTy>
const typename ByteBus<AddressTy>::Page & ByteBus<AddressTy>::get_page(const AddressTy address) const
{
...
template<typename AddressTy>
ubyte ByteBus<AddressTy>::read_ubyte(const BusContext context, const AddressTy address) const
{
...
template<typename AddressTy>
void ByteBus<AddressTy>::write_ubyte(const BusContext context, const AddressTy address, const ubyte value) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
uhword ByteBus<AddressTy>::read_uhword(const BusContext context, const AddressTy address) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
void ByteBus<AddressTy>::write_uhword(const BusContext context, const AddressTy address, const uhword value) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
uword ByteBus<AddressTy>::read_uword(const BusContext context, const AddressTy address) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
void ByteBus<AddressTy>::write_uword(const BusContext context, const AddressTy address, const uword value) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
udword ByteBus<AddressTy>::read_udword(const BusContext context, const AddressTy address) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
void ByteBus<AddressTy>::write_udword(const BusContext context, const AddressTy address, const udword value) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
uqword ByteBus<AddressTy>::read_uqword(const BusContext context, const AddressTy address) const
{
	auto& page = get_page(address);
	usize offset = address - page.base_address;
...
template<typename AddressTy>
void ByteBus<AddressTy>::write_uqword(const BusContext context, const AddressTy address, const uqword value) const
{
...
template<typename AddressTy>
size_t ByteBus<AddressTy>::get_vdn(const AddressTy address) const
{
